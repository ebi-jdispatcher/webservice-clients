...
baseUrl = u'https://www.ebi.ac.uk/Tools/services/rest/emboss_stretcher'
...
Asynchronous job:
  ...
  Usage: python emboss_stretcher.py --asyncjob --email <your@email.com> [options...] <SeqFile|SeqID(s)>
  Returns: jobid
