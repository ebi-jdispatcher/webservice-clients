...
#
# HMMER3 nhmmer (REST) web service Python client using xmltramp2.
#
...
def print_usage():
    print("""\
EMBL-EBI HMMER3 nhmmer Python Client:

Sequence similarity search with HMMER3 nhmmer.
...
[General]
  ...
  --baseUrl             Base URL. Defaults to:
                        https://www.ebi.ac.uk/Tools/services/rest/hmmer3_nhmmer

Synchronous job:
  The results/errors are returned as soon as the job is finished.
  Usage: python hmmer3_nhmmer.py --email <your@email.com> [options...] <SeqFile|SeqID(s)>
  Returns: results as an attachment

Asynchronous job:
  Use this if you want to retrieve the results at a later time. The results
  are stored for up to 24 hours.
  Usage: python hmmer3_nhmmer.py --asyncjob --email <your@email.com> [options...] <SeqFile|SeqID(s)>
  Returns: jobid

Check status of Asynchronous job:
  Usage: python hmmer3_nhmmer.py --status --jobid <jobId>

Retrieve job data:
  Use the jobid to query for the status of the job. If the job is finished,
  it also returns the results/errors.
  Usage: python hmmer3_nhmmer.py --polljob --jobid <jobId> [--outfile string]
...
baseUrl = u'https://www.ebi.ac.uk/Tools/services/rest/hmmer3_nhmmer'
version = u'2024-07-23 15:05'
