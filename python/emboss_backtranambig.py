...
#
# EMBOSS backtranambig (REST) web service Python client using xmltramp2.
#
...
baseUrl = u'https://www.ebi.ac.uk/Tools/services/rest/emboss_backtranambig'
...
def print_usage():
    print("""\
EMBL-EBI EMBOSS backtranambig Python Client:
...
Synchronous job:
  ...
  Usage: python emboss_backtranambig.py --email <your@email.com> [options...] <SeqFile|SeqID(s)>
  Returns: results as an attachment

Asynchronous job:
  Use this if you want to retrieve the results at a later time. The results
  are stored for up to 24 hours.
  Usage: python emboss_backtranambig.py --asyncjob --email <your@email.com> [options...] <SeqFile|SeqID(s)>
  Returns: jobid

Check status of Asynchronous job:
  Usage: python emboss_backtranambig.py --status --jobid <jobId>

Retrieve job data:
  Use the jobid to query for the status of the job. If the job is finished,
  it also returns the results/errors.
  Usage: python emboss_backtranambig.py --polljob --jobid <jobId> [--outfile string]
