...
#
# HMMER 3 phmmer (REST) web service Python client.
#
###############################################################################
...
description = u'''Protein function analysis with HMMER 3 phmmer.'''
epilog = u'''For further information about the HMMER 3 phmmer web service, see
https://www.ebi.ac.uk/tools/webservices/services/pfa/hmmer3_phmmer_rest.'''
version = u'798c88f'
