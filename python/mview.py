...
#
# Mview (REST) web service Python client.
#
###############################################################################
...
description = u'''Multiple sequence alignment viewing with MView.'''
epilog = u'''For further information about the Mview web service, see
https://www.ebi.ac.uk/tools/webservices/services/msa/mview_rest.'''
version = u'e4a1c6c'
