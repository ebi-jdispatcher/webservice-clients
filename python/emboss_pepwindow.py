...
#
# EMBOSS pepwindow (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with pepwindow.'''
epilog = u'''For further information about the EMBOSS pepwindow web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_pepwindow_rest.'''
version = u'798c88f'
