...
#
# SAPS (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with SAPS.'''
epilog = u'''For further information about the SAPS web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/saps_rest.'''
version = u'798c88f'
