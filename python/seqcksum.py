...
#
# EMBOSS seqcksum (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequenc operations with seqcksum.'''
epilog = u'''For further information about the EMBOSS seqcksum web service, see
https://www.ebi.ac.uk/tools/webservices/services/so/seqcksum_rest.'''
version = u'e4a1c6c'
