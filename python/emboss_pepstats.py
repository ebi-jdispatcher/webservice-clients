...
#
# EMBOSS pepstats (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with pepstats.'''
epilog = u'''For further information about the EMBOSS pepstats web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_pepstats_rest.'''
version = u'e4a1c6c'
