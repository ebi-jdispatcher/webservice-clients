...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_matcher'
...
'''
epilog = u'''For further information about the EMBOSS MATCHER web service, see
...
parser.add_option('--alternatives', help='Show additional alignments')
