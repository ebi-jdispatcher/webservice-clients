...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/wise2dba'
...
description = u'''\
    DNA Block Aligner (DBA) aligns two sequences under the assumption that the sequences share a number of colinear blocks of conservation separated by potentially large and varied lengths of DNA in the two sequences. \
\	\
'''
epilog = u'''For further information about the WISE 2 DBA web service, see
http://www.ebi.ac.uk/tools/webservices/services/psa/wise2dba_rest.'''
version = u'ee8df29'
