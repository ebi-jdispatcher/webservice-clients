...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_pepwindow'
...
'''
epilog = u'''For further information about the EMBOSS pepwindow web service, see
...
parser.add_option('--sequence', help='The sequence to be analysed can be entered directly into this form. The sequence can be in GCG, FASTA, PIR, NBRF, PHYLIP or UniProtKB/Swiss-Prot format.\
                Partially formatted sequences are not accepted..\
            ')
parser.add_option('--windowsize', help='Window size for averaging (smoothing) the hydropathy plot. Use an integer between 1 and 200.')
