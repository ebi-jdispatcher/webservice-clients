...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/kalign'
...
'''
epilog = u'''For further information about the Kalign web service, see
...
parser.add_option('--stype', help='Indicates if the sequences to align are protein or nucleotide (DNA/RNA).')
parser.add_option('--format', help='Format for generated multiple sequence alignment.')
parser.add_option('--gapopen', help='The penalty for opening/closing a gap. Half the value will be subtracted from the alignment score when opening, and half when closing a gap.')
parser.add_option('--gapext', help='Penalty for extending a gap')
parser.add_option('--termgap', help='Penalty to extend gaps from the N/C terminal of protein or 5\'/3\' terminal of nucleotide sequences')
...
\	\	\	There is currently a sequence input limit of 2000 sequences and 2MB of data.')
# General options
