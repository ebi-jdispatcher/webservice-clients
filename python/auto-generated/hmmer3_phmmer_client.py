...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/hmmer3_phmmer'
...
description = u'''\
    Hmmer3 phmmer is used to search sequences against collections of profiles.\
'''
epilog = u'''For further information about the Hmmer3 Phmmer web service, see
http://www.ebi.ac.uk/tools/webservices/services/pfa/hmmer3_phmmer_rest.'''
version = u'ee8df29'
...
parser.add_option('--evalue', help='Expectation value cut-off for reporting target profiles in the per-target output. \
\	\	\	')
parser.add_option('--sequence', help='The input sequence can be entered directly into this form. The sequence can be be in FASTA or UniProtKB/Swiss-Prot format. A partially formatted sequence is not accepted. Adding a return to the end of the sequence may help certain applications understand the input. Note that directly using data from word processors may yield unpredictable results as hidden/control characters may be present.')
# General options
