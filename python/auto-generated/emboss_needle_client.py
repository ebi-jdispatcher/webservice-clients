...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_needle'
...
'''
epilog = u'''For further information about the EMBOSS NEEDLE web service, see
...
parser.add_option('--endextend', help='Penalty is added to the end gap penalty for each base or residue in the end gap. This is how long end gaps are penalized.')
