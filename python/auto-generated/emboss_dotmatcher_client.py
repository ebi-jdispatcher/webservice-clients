...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_dotmatcher'
...
'''
epilog = u'''For further information about the EMBOSS dotmatcher web service, see
http://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_dotmatcher_rest.'''
version = u'0449464'
...
parser.add_option('--windowsize', help='Window size over which to test threshold')
parser.add_option('--threshold', help='Threshold')
# General options
