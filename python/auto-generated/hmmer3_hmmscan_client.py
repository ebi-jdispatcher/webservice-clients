...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/hmmer3_hmmscan'
...
description = u'''\
    Hmmer3 hmmscan is used to search sequences against collections of profiles.\
'''
epilog = u'''For further information about the Hmmer3 Hmmscan web service, see
http://www.ebi.ac.uk/tools/webservices/services/pfa/hmmer3_hmmscan_rest.'''
version = u'ee8df29'
...
parser.add_option('--incE', help='Significance E-values[Model]')
parser.add_option('--incdomE', help='Significance E-values[Hit]')
parser.add_option('--E', help='Report E-values[Model]')
