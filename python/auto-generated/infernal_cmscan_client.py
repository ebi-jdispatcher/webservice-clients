...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/infernal_cmscan'
...
'''
epilog = u'''For further information about the INFERNAL CM SCAN web service, see
http://www.ebi.ac.uk/tools/webservices/services/rna/infernal_cmscan_rest.'''
version = u'ee8df29'
...
parser.add_option('--thresholdmodel', help='Model-specific reporting thresholds.')
parser.add_option('--sequence', help='The input sequence can be entered directly into this form. The sequence can be in GCG, FASTA, EMBL, GenBank, PIR, NBRF or PHYLIP format. A partially formatted sequence is not accepted. Adding a return to the end of the sequence may help certain applications understand the input. Note that directly using data from word processors may yield unpredictable results as hidden/control characters may be present.')
# General options
