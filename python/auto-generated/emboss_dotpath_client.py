...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_dotpath'
...
'''
epilog = u'''For further information about the EMBOSS dotpath web service, see
http://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_dotpath_rest.'''
version = u'98c6601'
...
parser.add_option('--overlaps', help='Displays the overlapping matches (in red) as well as the minimal set of non-overlapping matches.')
