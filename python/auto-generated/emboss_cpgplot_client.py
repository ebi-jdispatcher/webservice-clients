...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_cpgplot'
...
'''
epilog = u'''For further information about the EMBOSS cpgplot web service, see
...
parser.add_option('--sequence', help='One or more sequences to be analysed can be entered directly into this form.\
            Sequences can be in GCG, FASTA, EMBL, GenBank, PIR, NBRF or PHYLIP format.\
