...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_pepinfo'
...
'''
epilog = u'''For further information about the EMBOSS pepinfo web service, see
...
\	\	\	\	Partially formatted sequences are not accepted..\
            ')
parser.add_option('--hwindow', help='This sets the window size for averaging (smoothing) the hydropathy plots. By default a window size of 9 is used, please use an integer between 1 and 200.')
# General options
