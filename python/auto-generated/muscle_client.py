...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/muscle'
...
'''
epilog = u'''For further information about the Muscle web service, see
...
parser.add_option('--tree', help='The guide tree to output')
