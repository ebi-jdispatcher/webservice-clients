...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/mview'
...
'''
epilog = u'''For further information about the Mview web service, see
http://www.ebi.ac.uk/tools/webservices/services/msa/mview_rest.'''
version = u'98c6601'
...
parser.add_option('--informat', help='Format of the input sequence similarity search result or multiple sequence alignment to be processed.')
...
parser.add_option('--sequence', help='Sequence similarity search result (e.g. BLAST or FASTA search report) or a multiple sequence alignment.')
# General options
