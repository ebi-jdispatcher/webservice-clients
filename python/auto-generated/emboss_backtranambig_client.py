...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/emboss_backtranambig'
...
'''
epilog = u'''For further information about the EMBOSS backtranambig web service, see
http://www.ebi.ac.uk/tools/webservices/services/st/emboss_backtranambig_rest.'''
version = u'ee8df29'
...
parser.add_option('--sequence', help='One or more sequences to be translated can be entered directly into this form.\
                Sequences can be in GCG, FASTA, PIR, NBRF, PHYLIP or UniProtKB/Swiss-Prot format.\
                Partially formatted sequences are not accepted. Adding a return to the end of the sequence may help certain applications understand the input.\
