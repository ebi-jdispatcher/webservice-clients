...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/saps'
...
'''
epilog = u'''For further information about the SAPS web service, see
...
parser.add_option('--positiveresidues', help='By default, SAPS treats only lysine (K) and arginine (R) as positively charged residues.\
