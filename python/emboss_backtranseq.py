...
#
# EMBOSS backtranseq (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence translations with backtranseq.'''
epilog = u'''For further information about the EMBOSS backtranseq web service, see
https://www.ebi.ac.uk/tools/webservices/services/st/emboss_backtranseq_rest.'''
version = u'e4a1c6c'
