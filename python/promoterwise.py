...
#
# Promoterwise (REST) web service Python client using xmltramp2.
#
...
baseUrl = u'https://www.ebi.ac.uk/Tools/services/rest/promoterwise'
...
parser.add_option('--hitoutput', type=str, help=('Hit list output format'))
...
def print_usage():
    print("""\
EMBL-EBI Promoterwise Python Client:
...
Asynchronous job:
  ...
  Usage: python promoterwise.py --asyncjob --email <your@email.com> [options...] <SeqFile|SeqID(s)>
  Returns: jobid
