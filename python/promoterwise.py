...
#
# Promoterwise (REST) web service Python client.
#
###############################################################################
...
description = u'''Pairwise sequence alignment with Promoterwise.'''
epilog = u'''For further information about the Promoterwise web service, see
https://www.ebi.ac.uk/tools/webservices/services/psa/promoterwise_rest.'''
version = u'798c88f'
