...
#
# Clustal Omega (REST) web service Python client.
#
###############################################################################
...
description = u'''Multiple sequence alignment with Clustal Omega.'''
epilog = u'''For further information about the Clustal Omega web service, see
https://www.ebi.ac.uk/tools/webservices/services/msa/clustalo_rest.'''
version = u'e4a1c6c'
...
parser.add_option('--dismatout', help=('Output distance matrix. This is only calculated if the mBed-like'
...
parser.add_option('--mbed', help=('This option uses a sample of the input sequences and then represents'
