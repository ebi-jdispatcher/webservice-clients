...
# 
# ======================================================================
# EMBOSS WATER (REST) Python client using urllib2 and
...
description = """EMBOSS Water uses the Smith-Waterman algorithm (modified for speed enhancments) to calculate the local alignment of a sequence to one or more other sequences."""
epilog = """For further information about the EMBOSS WATER(REST) web service, see http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_water_rest."""
version = "$Id: emboss_water_urllib2.py 2809 2017-02-10 16:10:25Z afoix $"
