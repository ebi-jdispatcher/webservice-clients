#!/usr/bin/env python
# $Id: promoterwise_urllib2.py 2809 2017-02-14 16:10:25Z afoix $
# ======================================================================
# 
...
# 
# ======================================================================
# PROMOTERWISE (REST) Python client using urllib2 and
...
#
# See:
# http://www.ebi.ac.uk/Tools/webservices/services/psa/promoterwise_rest
# http://www.ebi.ac.uk/Tools/webservices/tutorials/python
# ======================================================================
# Base URL for service
baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/promoterwise'
# Load libraries
...
description = """PromoterWise compares two DNA sequences allowing for inversions and translocations, ideal for promoters."""
epilog = """For further information about the PROMOTERWISE (REST) web service, see http://www.ebi.ac.uk/Tools/webservices/services/psa/wise2dba_rest."""
version = "$Id: promoterwise_urllib2.py 2809 2017-02-10 16:10:25Z afoix $"
# Process command-line options
parser = OptionParser(usage=usage, description=description, epilog=epilog, version=version)
# Tool specific options
parser.add_option('--hitoutput', help='Hit list output format')
...
# Submit job
    ...
    if options.hitoutput:
        params['hitoutput'] = options.hitoutput
    # Submit the job
