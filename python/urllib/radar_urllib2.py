...
#
# ======================================================================
# RADAR (REST) Python client using urllib2 and
...
#
# See:
# http://www.ebi.ac.uk/Tools/webservices/services/pfa/radar_rest
# http://www.ebi.ac.uk/Tools/webservices/tutorials/python
# ======================================================================
# Base URL for service
baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/radar'
...
description = """RADAR identifies gapped approximate repeats and complex repeat architectures involving many different types of repeats.
For more information on PRATT refer to http://www.ebi.ac.uk/Tools/pfa/radar"""
epilog = """For further information about the RADAR (REST) web service, see
http://www.ebi.ac.uk/Tools/webservices/services/sss/pratt_rest."""
version = "$Id: radar_urllib2.py 2797 2017-02-13 15:02:06Z afoix $"
# Process command-line options
parser = OptionParser(usage=usage, description=description, epilog=epilog, version=version)
# Tool specific options
parser.add_option('--sequence', help='Query sequence file or DB:ID')
parser.add_option('--multifasta', help='Multiple fasta input (job/sequence)')
# General options
