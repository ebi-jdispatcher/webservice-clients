#!/usr/bin/env python
# $Id: hmmer_hmmscan_urllib2.py 2809 2017-02-14 16:10:25Z afoix $
# ======================================================================
#
...
#
# ======================================================================
# HMMER HMMSCAN (REST) Python client using urllib2 and
...
baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/hmmer_hmmscan'
...
description = """HMMER hmmscan is used to search sequences against collections of profiles."""
epilog = """For further information about the HMMER hmmscan(REST) web service, see http://www.ebi.ac.uk/Tools/webservices/services/pfa/hmmer_hmmscan_rest"""
version = "$Id: pfamscan_urllib2.py 2809 2017-02-10 16:10:25Z afoix $"
# Process command-line options
parser = OptionParser(usage=usage, description=description, epilog=epilog, version=version)
# Tool specific options
parser.add_option('-D', '--database', help='database to search')
parser.add_option('--cutoffOption', help='Threshold method')
parser.add_option('--cut_ga', help='GA thresholds')
parser.add_option('-E', '--evalue', help='E-value threshold')
parser.add_option('--noasp', help='Disable active site prediction')
...
parser.add_option('--useSeqId', help='output format for results')
parser.add_option('--maxJobs', help='Max. parallel jobs')
...
# Submit job
    ...
    elif options.cutoffOption:
        params['cutoffOption'] = options.cutoffOption
    elif options.cut_ga:
        params['cut_ga'] = options.cut_ga
    elif options.evalue:
        params['evalue'] = options.evalue
    elif options.multifasta:
