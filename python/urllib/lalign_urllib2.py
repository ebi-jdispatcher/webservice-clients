#!/usr/bin/env python
# $Id: lalign_urllib2.py 2809 2017-02-14 16:10:25Z afoix $
# ======================================================================
# 
...
# 
# ======================================================================
# EMBOSS LALIGN (REST) Python client using urllib2 and
...
baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/lalign'
# Load libraries
...
description = """LALIGN finds internal duplications by calculating non-intersecting local alignments of protein or DNA sequences."""
epilog = """For further information about the LALIGN (REST) web service, see http://www.ebi.ac.uk/Tools/webservices/services/psa/lalign_rest."""
version = "$Id: lalign_urllib2.py 2809 2017-02-10 16:10:25Z afoix $"
...
parser.add_option('--expthr', help='E-value threshold')
...
parser.add_option('--graphics', help='Enable graphic output')
# General options
