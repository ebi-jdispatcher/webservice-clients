...
For more information on PRATT refer to http://www.ebi.ac.uk/Tools/pfa/pratt"""
...
parser.add_option('--minPerc', help='Minimum percentage of input sequence to match')
parser.add_option('--patternPosition', help='Pattern position in sequence')
parser.add_option('--maxPatternLength', help='Maximum pattern length')
parser.add_option('--maxNumPatternSymbols', help='Maximum number Of pattern symbols')
...
parser.add_option('--patternSymbolFile', action="store_true", help='Enable pattern symbol file')
parser.add_option('--noPatternSymbolFile', help='Disable pattern symbol file')
parser.add_option('--numPatternSymbols', help='Number of pattern symbols used')
parser.add_option('--patternScoring', help='Pattern scoring')
parser.add_option('--patternGraph', help='Pattern graph allows the use of an alignment or a query sequence to restrict the pattern search')
parser.add_option('--searchGreediness', help='Greediness of the search')
parser.add_option('--patternRefinement', help='Enable pattern refinement')
parser.add_option('--nopatternRefinement', help='Disable pattern refinement')
parser.add_option('--genAmbigSymbols', help='Enable generalise ambiguous symbols')
parser.add_option('--noGenAmbigSymbols', help='Disable generalise ambiguous symbols')
parser.add_option('--patternFormat', help='Enable PROSITE pattern format')
parser.add_option('--noPatternFormat', help='Disable PROSITE pattern format')
parser.add_option('--maxNumPatterns', help='Maximum number of patterns')
parser.add_option('--maxNumAlignments', help='Maximum number of alignments between 1 and 100')
parser.add_option('--printPatterns', help='Enable print Patterns in sequences')
parser.add_option('--noPrintPatterns', help='Disable print Patterns in sequences')
parser.add_option('--printingRatio', help='Printing ratio')
parser.add_option('--printVertically', help='Enable print vertically')
parser.add_option('--noPrintVertically', help='Disable print vertically')
...
# Submit job
    ...
    if options.nopatternRefinement:
        params['nopatternRefinement'] = options.nopatternRefinement
    if options.maxNumPatternSymbols:
        params['maxNumPatternSymbols'] = options.match_score
