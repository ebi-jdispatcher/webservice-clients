#!/usr/bin/env python
# $Id: emboss_stretcher_urllib2.py 2809 2017-02-14 16:10:25Z afoix $
# ======================================================================
# 
...
# 
# ======================================================================
# EMBOSS STRETCHER (REST) Python client using urllib2 and
...
description = """EMBOSS Stretcher calculates an optimal global alignment of two sequences using a modification of the classic dynamic programming algorithm which uses linear space."""
epilog = """For further information about the EMBOSS STRETCHER (REST) web service, see http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_stretcher_rest."""
version = "$Id: emboss_stretcher_urllib2.py 2809 2017-02-10 16:10:25Z afoix $"
