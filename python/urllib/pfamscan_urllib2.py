...
# 
# ======================================================================
# Pfam Scan (REST) Python client using urllib2 and
...
description = """Pfam is used to search a FASTA sequence against a library of Pfam HHM."""
epilog = """For further information about the PfamScan(REST) web service, see http://www.ebi.ac.uk/Tools/webservices/services/pfa/pfamscan_rest."""
...
parser.add_option('--asp', help='Enable active site prediction')
