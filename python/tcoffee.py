...
#
# T-coffe (REST) web service Python client using xmltramp2.
#
...
Asynchronous job:
  ...
  Usage: python tcoffee.py --asyncjob --email <your@email.com> [options...] <SeqFile|SeqID(s)>
  Returns: jobid
