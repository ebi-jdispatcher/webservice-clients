...
#
# T-coffe (REST) web service Python client.
#
###############################################################################
...
description = u'''Multiple sequence alignment with T-coffee.'''
epilog = u'''For further information about the T-coffe web service, see
https://www.ebi.ac.uk/tools/webservices/services/msa/tcoffee_rest.'''
version = u'e4a1c6c'
