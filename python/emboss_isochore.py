...
#
# EMBOSS isochore (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with isochore.'''
epilog = u'''For further information about the EMBOSS isochore web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_isochore_rest.'''
version = u'e4a1c6c'
