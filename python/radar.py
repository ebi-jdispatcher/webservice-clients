...
#
# RADAR (REST) web service Python client.
#
###############################################################################
...
description = u'''Protein function analysis with Radar.'''
epilog = u'''For further information about the RADAR web service, see
https://www.ebi.ac.uk/tools/webservices/services/pfa/radar_rest.'''
version = u'798c88f'
