...
#
# FASTA (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence similarity search with FASTA.'''
epilog = u'''For further information about the FASTA web service, see
https://www.ebi.ac.uk/tools/webservices/services/sss/fasta_rest.'''
version = u'e4a1c6c'
