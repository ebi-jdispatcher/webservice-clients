...
#
# EMBOSS dotpath (REST) web service Python client.
#
###############################################################################
...
baseUrl = u'https://www.ebi.ac.uk/Tools/services/rest/emboss_dotpath'
...
description = u'''Sequence statistics and plots with dotpath.'''
epilog = u'''For further information about the EMBOSS dotpath web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_dotpath_rest.'''
version = u'e4a1c6c'
