...
#
# EMBOSS dotmatcher (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with dotmatcher.'''
epilog = u'''For further information about the EMBOSS dotmatcher web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_dotmatcher_rest.'''
version = u'e4a1c6c'
