...
#
# EMBOSS transeq (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence translations with transeq.'''
epilog = u'''For further information about the EMBOSS transeq web service, see
https://www.ebi.ac.uk/tools/webservices/services/st/emboss_transeq_rest.'''
version = u'e4a1c6c'
