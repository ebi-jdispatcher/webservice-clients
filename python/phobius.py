...
#
# PHOBIUS (REST) web service Python client.
#
###############################################################################
...
description = u'''Protein function analysis with Phobius.'''
epilog = u'''For further information about the PHOBIUS web service, see
https://www.ebi.ac.uk/tools/webservices/services/pfa/phobius_rest.'''
version = u'e4a1c6c'
