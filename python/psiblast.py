...
#
# PSI-Blast (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence similarity search with PSI-Blast.'''
epilog = u'''For further information about the PSI-Blast web service, see
https://www.ebi.ac.uk/tools/webservices/services/sss/psiblast_rest.'''
version = u'e4a1c6c'
