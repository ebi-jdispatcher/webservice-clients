...
#
# EMBOSS polydot (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with polydot.'''
epilog = u'''For further information about the EMBOSS polydot web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_polydot_rest.'''
version = u'e4a1c6c'
