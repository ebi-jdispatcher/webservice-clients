...
baseUrl = u'http://www.ebi.ac.uk/Tools/services/rest/mafft'
...
'''
epilog = u'''For further information about the Mafft web service, see
...
parser.add_option('--matrix', help='Protein comparison matrix to be used when adding sequences to the alignment.')
parser.add_option('--gapopen', help='Penalty for first base/residue in a gap.')
