#!/usr/bin/env python
# $Id: psiblast_urllib2.py 2673 2013-10-26 05:56:18Z hpm $
# ======================================================================
#
...
#
# ======================================================================
# PSI BLAST (REST) Python client using urllib2 and
...
description = """Position specific iterative BLAST (PSI-BLAST) refers to a feature of BLAST 2.0
in which a profile is automatically constructed from the first set of BLAST alignments. For more information
on PSI-BLAST refer to http://www.ebi.ac.uk/Tools/sss/psiblast"""
epilog = """For further information about the PSI-BLAST (REST) web service, see
http://www.ebi.ac.uk/Tools/webservices/services/sss/psiblast_rest."""
version = "$Id: psiblast_urllib2.py 2673 2013-10-26 05:56:18Z afoix $"
...
parser.add_option('--expthr', help='E-value threshold for search')
parser.add_option('--psithr', help='E-value threshold for PSI')
parser.add_option('-f', '--filter', action="store_true", help='low complexity sequence filter')
parser.add_option('--alignView', help='Pairwise alignment format')
...
parser.add_option('--finaldropoff', type='int', help='Final dropoff score')
...
parser.add_option('--selectedHits', help='Selected hits for building PSSM')
parser.add_option('--cpfile', help='PSI-BLAST checkpoint')
