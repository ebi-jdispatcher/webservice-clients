#!/usr/bin/env python
# $Id: emboss_matcher_urllib2.py 2809 2017-02-14 16:10:25Z afoix $
# ======================================================================
#
...
#
# ======================================================================
# EMBOSS MATCHER (REST) Python client using urllib2 and
...
description = """EMBOSS MATCHER identifies local similarities between two sequences using a rigorous algorithm based on the LALIGN application."""
epilog = """For further information about the EMBOSS MATCHER (REST) web service, see http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_matcher_rest."""
version = "$Id: emboss_matcher_urllib2.py 2809 2017-02-10 16:10:25Z afoix $"
...
parser.add_option('--alternatives', help='Alternative alignments')
