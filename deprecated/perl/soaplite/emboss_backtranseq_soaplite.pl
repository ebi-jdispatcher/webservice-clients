...
emboss_backtranseq_soaplite.pl

=head1 DESCRIPTION

EMBOSS Backtranseq (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_backtranseq_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/emboss_backtranseq?wsdl';
...
Back-translate a protein sequence into a nucleotide sequence.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_backtranseq_soap
