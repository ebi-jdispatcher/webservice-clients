...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/rna/mapmi_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/mapmi';
...
[Optional]
      ...
      --bowtie           : int  : Maximum matches per genome
      --excludecan       :      : Exclude candidates
