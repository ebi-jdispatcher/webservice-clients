 ...
 * 
 * ======================================================================
 * JDispatcher Wise2DBA (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.wise2dba.*;

/** <p>JDispatcher Wise2DBA (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/wise2dba_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/wise2dba_soap</a></li>
 ...
 * </ul>
 */
public class Wise2DBAClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "Wise2DBA\n"
		+ "========\n"
		+ "\n"
		...
		+ "[Optional]\n"
		+ "\n"
		+ "      --para          :      : Enable parameter display in output.\n"
		+ "      --nopara        :      : Disable parameter display in output.\n"
		+ "      --pretty        :      : Enable pretty ASCII alignment in output.\n"
		+ "      --nopretty      :      : Disable pretty ASCII alignment in output.\n";

	/** Default constructor.
	 */
	public Wise2DBAClient() {
	...
	protected String getClientUserAgentString() {
		...
		if(this.revision.length() > 13) {
			clientVersion = this.revision.substring(11, this.revision.length() - 2);
		}
	 ...
	 * @param inputData
	 *            Data input. Ignored, data input via command-line options.
	 * @throws ServiceException
	 * @throws IOException
	 */
	public String submitJobFromCli(CommandLine cli, String inputData)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar Wise2DBA_Axis1.jar --status --jobid "
							+ jobid);
		} else {
	...
	public static void main(String[] args) {
		...
		Wise2DBAClient client = new Wise2DBAClient();
		try {
