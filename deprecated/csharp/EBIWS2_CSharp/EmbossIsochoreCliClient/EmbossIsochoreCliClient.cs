 ...
 * 
 * ======================================================================
 * jDispatcher EMBOSS isochore (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossIsochoreWs;

namespace EbiWS
{
	class EmbossIsochoreCliClient : EbiWS.EmbossIsochoreClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS isochore
===============
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossIsochoreCliClient wsApp = new EmbossIsochoreCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "--shift": // Shift increment
					InParams.shift = Convert.ToInt32(args[++i]);
					InParams.shiftSpecified = true;
					break;
				case "/shift":
					goto case "--shift";
