 ...
 * 
 * ======================================================================
 * jDispatcher EMBOSS stretcher (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossStretcherWs;

namespace EbiWS
{
	class EmbossStretcherCliClient : EbiWS.EmbossStretcherClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS stretcher
================
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossStretcherCliClient wsApp = new EmbossStretcherCliClient();
