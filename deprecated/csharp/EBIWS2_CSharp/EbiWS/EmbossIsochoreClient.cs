 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS isochore (SOAP) client.
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_isochore_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossIsochoreWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS isochore (SOAP) web service.
	/// </summary>	
	public class EmbossIsochoreClient : EbiWS.AbstractWsClient
	{
