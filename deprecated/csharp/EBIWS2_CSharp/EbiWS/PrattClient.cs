 ...
 * 
 * ======================================================================
 * JDispatcher SOAP client for Pratt
 * 
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/pratt_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.PrattWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI Pratt SOAP web service.
	/// </summary>
	public class PrattClient : EbiWS.AbstractWsClient
	{
