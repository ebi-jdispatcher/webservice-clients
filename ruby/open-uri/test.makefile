...
# ======================================================================
#
# Test sample EMBL-EBI open-uri based web services clients.
#
# ======================================================================
...
dbfetch_getSupportedDBs:
	${RUBY} dbfetch_open-uri.rb getSupportedDBs > dbfetch-getSupportedDBs.txt

dbfetch_getSupportedFormats:
	${RUBY} dbfetch_open-uri.rb getSupportedFormats > dbfetch-getSupportedFormats.txt

dbfetch_getSupportedStyles:
	echo 'TODO:' $@

dbfetch_getDbFormats:
	${RUBY} dbfetch_open-uri.rb getDbFormats uniprotkb > dbfetch-getDbFormats.txt

dbfetch_getFormatStyles:
	${RUBY} dbfetch_open-uri.rb getFormatStyles uniprotkb default > dbfetch-getFormatStyles.txt

dbfetch_fetchData: dbfetch_fetchData_string dbfetch_fetchData_file dbfetch_fetchData_stdin

dbfetch_fetchData_string:
	${RUBY} dbfetch_open-uri.rb fetchData 'UNIPROTKB:WAP_RAT' > dbfetch-fetchData.txt
...
dbfetch_fetchBatch_string:
	${RUBY} dbfetch_open-uri.rb fetchBatch uniprotkb 'WAP_RAT,WAP_MOUSE' fasta raw > dbfetch-fetchBatch.txt
