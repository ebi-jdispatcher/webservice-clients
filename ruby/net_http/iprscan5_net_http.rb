...
# 
# ======================================================================
# InterProScan 5 (REST) sample Ruby client using net/http and REXML.
#
# Tested with:
#   Ruby 1.8.7 (Ubuntu 10.04 LTS, Ubuntu 12.04 LTS)
#
# See:
# http://www.ebi.ac.uk/Tools/webservices/pfa/iprscan5_rest
...
def printUsage(returnCode)
  scriptName = 'iprscan5_net_http.rb'
  puts <<END_OF_STRING
InterProScan 5
==============
...
begin
  ...
  ebiWsApp = EbiWsIPRScan5.new(outputLevel, argHash['debugLevel'], timeout)
  ...
  # Submit a job
    ...
    if argHash['nopathways']
      params['pathways'] = 'false'
    elsif argHash['pathways']
