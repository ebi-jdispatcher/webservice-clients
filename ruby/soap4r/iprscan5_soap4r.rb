...
# 
# ======================================================================
# InterProScan 5 (SOAP) Ruby client using soap4r.
#
# Tested with:
#   SOAP4R 1.5.5 and Ruby 1.8.7 (Ubuntu 10.04 LTS, Ubuntu 12.04 LTS)
#   SOAP4R 1.5.8 and Ruby 1.8.7
#
# See:
# http://www.ebi.ac.uk/Tools/webservices/pfa/iprscan5_soap
...
require 'iprscan5Driver.rb' # Generated stubs

# Usage message
def printUsage(returnCode)
  scriptName = 'iprscan5_soap4r.rb'
  puts <<END_OF_STRING
InterProScan 5
==============
...
optParser = GetoptLong.new(
                           ...
                           ['--pathways', GetoptLong::NO_ARGUMENT],
                           ['--nopathways', GetoptLong::NO_ARGUMENT],
...
class EbiWsIPRScan5
  ...
  def getParams()
    ...
    # 'id' is a restricted attribute name, so a work-around is required to 
...
begin
  ...
  ebiWsApp = EbiWsIPRScan5.new(argHash['outputLevel'], argHash['debugLevel'], argHash['trace'], timeout)
  ...
  # Submit a job
    ...
    #if(argHash['crc']) # Ignore for compatibility.
    #  params.nocrc = false
    #elsif(argHash['nocrc'])
    #  params.nocrc = true
    #end
