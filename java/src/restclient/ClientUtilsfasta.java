...
public class ClientUtilsfasta {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilsfasta.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilsfasta.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilsfasta.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientfasta client, String jobid, int interval,
