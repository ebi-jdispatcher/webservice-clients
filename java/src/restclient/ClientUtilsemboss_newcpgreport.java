...
public class ClientUtilsemboss_newcpgreport {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilsemboss_newcpgreport.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilsemboss_newcpgreport.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilsemboss_newcpgreport.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientemboss_newcpgreport client, String jobid, int interval,
