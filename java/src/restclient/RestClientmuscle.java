        ...
        try {
            ...
            // Details of selected parameter
                ...
                if (parameter != null) {
                    ...
                    ClientUtilsmuscle.marshallToXML(parameter);
                } else {
            ...
            // Submit new job
                ...
                String jobid = submitJob(cli, ClientUtilsmuscle.loadData(sequence));
            ...
            // Check already submitted job
                ...
                if (cli.hasOption("resultTypes")) {
                    ...
                    ClientUtilsmuscle.marshallToXML(getResultTypesForJobId(jobid));
                    if (outputLevel > 0)
