        ...
        try {
            ...
            // Details of selected parameter
                ...
                if (parameter != null) {
                    ...
                    ClientUtilspfamscan.marshallToXML(parameter);
                } else {
            ...
            // Submit new job
                ...
                String jobid = submitJob(cli, ClientUtilspfamscan.loadData(sequence));
            ...
            // Check already submitted job
                ...
                if (cli.hasOption("resultTypes")) {
                    ...
                    ClientUtilspfamscan.marshallToXML(getResultTypesForJobId(jobid));
                    if (outputLevel > 0)
