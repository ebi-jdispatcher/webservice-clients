...
public class RestClientemboss_stretcher {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RestClientemboss_stretcher.class);
        ...
        try {
            ...
            // Details of selected parameter
                ...
                if (parameter != null) {
                    ...
                    ClientUtilsemboss_stretcher.marshallToXML(parameter);
                } else {
            ...
            // Submit new job
                ...
                String jobid = submitJob(cli, ClientUtilsemboss_stretcher.loadData(sequence));
            ...
            // Check already submitted job
                ...
                if (cli.hasOption("resultTypes")) {
                    ...
                    ClientUtilsemboss_stretcher.marshallToXML(getResultTypesForJobId(jobid));
                    if (outputLevel > 0)
