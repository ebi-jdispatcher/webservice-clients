...
public class ClientUtilsinfernal_cmscan {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilsinfernal_cmscan.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilsinfernal_cmscan.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilsinfernal_cmscan.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientinfernal_cmscan client, String jobid, int interval,
