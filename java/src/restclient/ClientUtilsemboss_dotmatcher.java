...
public class ClientUtilsemboss_dotmatcher {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilsemboss_dotmatcher.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilsemboss_dotmatcher.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilsemboss_dotmatcher.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientemboss_dotmatcher client, String jobid, int interval,
