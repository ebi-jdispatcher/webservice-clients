...
public class ClientUtilsgenewise {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilsgenewise.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilsgenewise.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilsgenewise.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientgenewise client, String jobid, int interval,
