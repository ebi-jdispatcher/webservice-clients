...
public class ClientUtilshmmer3_phmmer {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilshmmer3_phmmer.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilshmmer3_phmmer.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilshmmer3_phmmer.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClienthmmer3_phmmer client, String jobid, int interval,
