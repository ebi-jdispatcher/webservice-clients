...
public class RestClientkalign {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RestClientkalign.class);
        ...
        try {
            ...
            // Details of selected parameter
                ...
                if (parameter != null) {
                    ...
                    ClientUtilskalign.marshallToXML(parameter);
                } else {
            ...
            // Submit new job
                ...
                String jobid = submitJob(cli, ClientUtilskalign.loadData(sequence));
            ...
            // Check already submitted job
                ...
                if (cli.hasOption("resultTypes")) {
                    ...
                    ClientUtilskalign.marshallToXML(getResultTypesForJobId(jobid));
                    if (outputLevel > 0)
