...
public class ClientUtilsemboss_backtranseq {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilsemboss_backtranseq.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilsemboss_backtranseq.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilsemboss_backtranseq.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientemboss_backtranseq client, String jobid, int interval,
