...
public class ClientUtilshmmer3_hmmscan {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilshmmer3_hmmscan.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilshmmer3_hmmscan.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilshmmer3_hmmscan.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClienthmmer3_hmmscan client, String jobid, int interval,
