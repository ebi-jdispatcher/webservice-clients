...
public class ClientUtilssimple_phylogeny {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilssimple_phylogeny.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilssimple_phylogeny.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilssimple_phylogeny.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientsimple_phylogeny client, String jobid, int interval,
