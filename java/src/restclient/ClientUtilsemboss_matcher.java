...
public class ClientUtilsemboss_matcher {


//    private static final Logger log = LoggerFactory.getLogger(ClientUtilsemboss_matcher.class);
    ...
    public static List<WsResultType> processUserOutputFormats(String cli, List<WsResultType> allResultTypes,
        ...
        for (String identifier : cli.split(",")) {
            ...
            String suffix = ClientUtilsemboss_matcher.getSuffixFor(identifier, allResultTypes);

            if (suffix != null) {
                resultType.setFileSuffix(ClientUtilsemboss_matcher.getSuffixFor(identifier, allResultTypes));
            } else {
...
// debugLevel));
     ...
     */
    public static boolean getStatusInIntervals(RestClientemboss_matcher client, String jobid, int interval,
