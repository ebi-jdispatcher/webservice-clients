...
public class EBeyeClient {
   ...
   private Client              clientForRawdata         = null;
   ...
   private static final String usageMsg                 = "EB-eye\n" + "======\n" + "\n" + "--getDomainsHierarchy\n"
                                                          ...
                                                          + "--getFacetedResultsFromSequenceAnalysisResults <domain> <toolid> <jobid> <fields> <query>? "
                                                          + "                  [OPTIONS: --size | --start | --fieldurl | --viewurl | --sortfield | --order | --sort | --facetcount | --facetfields | --facets | --facetsdepth | --tooloutputformat | --jobresultsstart | --jobresultssize | --jobresultsmapfield ]\n"
                                                          ...
                                                          + "--via <via>\t domain ids associated with finding cross-references.\n"
                                                          + "--tooloutputformat <tooloutputformat>\tSequence Tool output format configured in the system.\n"
                                                          + "--jobresultsstart <jobresultsstart>\tSequence Tool results reading start index.\n"
                                                          + "--jobresultssize <jobresultssize>\tSequence Tool results reading size.\n"
                                                          + "--jobresultsmapfield <jobresultsmapfield>\tSequence Tool results domain field to map on.\n"
                                                          + "--valuemappers <valuemappers>\tComma separated list of 'value mappers' to use on the sequence tool results.\n"
                                                          ...
                                                          + "Further information:\n" + "\n" + "  https://www.ebi.ac.uk/ebisearch/apidoc.ebi\n"
   ...
   public int getDebugLevel() {
      printDebugMessage("getDebugLevel", Integer.toString(debugLevel), 1);
      return debugLevel;
   }
   ...
   public int getOutputLevel() {
      printDebugMessage("getOutputLevel", Integer.toString(outputLevel), 1);
   ...
   private Properties loadProperties(InputStream in) throws IOException {
      ...
      try {
         ...
         printDebugMessage("getClient", String.format("Error loading Cache config from: [%s], message: [%s]", in.toString(), e.getMessage()), 0);
      } finally {
         if (in != null) {
            in.close();
         }
   ...
   protected Client createClient(boolean correctResponseNamespaceNeeded) {
      Client newClient = ClientBuilder.newClient();
      newClient.register(new GZIPInInterceptor());
      newClient.register(new GZIPOutInterceptor());
      ...
      if (enableCache) {
         ...
         MutableConfiguration<Key, Entry> ccfg = new MutableConfiguration<Key, Entry>().setStoreByValue(false).setExpiryPolicyFactory(AccessedExpiryPolicy.factoryOf(Duration.ONE_DAY)).setStatisticsEnabled(true);
         ...
         newClient.register(cacheFilter);
         ...
         newClient.register(cacheInterceptor);
      }
      if (correctResponseNamespaceNeeded) {
         newClient.register(getNamespaceAdditionFeature());
      }
      return newClient;
   }
   ...
   protected Client getClient() {
      if (client == null) {
         client = createClient(correctResponseNamespace);
      }
      return client;
   }

   protected Client getClientWithoutNamespaceCorrection() {
      if (clientForRawdata == null) {
         clientForRawdata = createClient(false);
      }
      return clientForRawdata;
   }
   ...
   public void close() {
      ...
      if (clientForRawdata != null) {
         clientForRawdata.getConfiguration().getInstances().forEach(obj -> {
            if (obj instanceof Closeable) {
               try {
                  ((Closeable) obj).close();
               } catch (Exception e) {
   ...
   public WsResult getDomainsHierarchy() {
      ...
      WebTarget t = getTarget();
      printDebugMessage("getDomainsHierarchy", getURLString(t), 2);
   ...
   public WsResult getNumberOfResults(String domain, String query) {
      ...
      WebTarget t = getTarget().path(domain).queryParam("query", query).queryParam("size", "0");

      printDebugMessage("getNumberOfResults", getURLString(t), 2);
      Invocation.Builder builder = t.request();
      WsResult result = builder.get(WsResult.class);
    ...
    * @return
    */
   public WsResult getResults(String domain, String query, String fields, int start, int size, boolean fieldurl, boolean viewurl, String sortField,
      ...
      Invocation.Builder builder = t.request();
      printDebugMessage("getResults", getURLString(t), 2);
      WsResult result = builder.get(WsResult.class);
   ...
   public WsResult getFacetedResultsFromSequenceAnalysisResults(String domain, String toolid, String jobid, String fields, String query, int start, int size,
                                                                boolean fieldurl, boolean viewurl, String sortField, String order, String sort, int facetCount,
                                                                String facetfields, String facets, int facetsdepth, String tooloutputformat, String jobresultsstart, String jobresultssize, String jobresultsmapfield, String valuemappers) {
      printDebugMessage("getFacetedResultsFromSequenceAnalysisResults", "Begin", 1);
      String path = domain + "/seqtoolresults";
      Invocation.Builder builder = getTarget().path(path)
            ...
            .queryParam("facetfields", facetfields)
            .queryParam("facets", facets)
            .queryParam("facetsdepth", facetsdepth)
            .queryParam("tooloutputformat", tooloutputformat)
            .queryParam("jobresultsstart", jobresultsstart)
            .queryParam("jobresultssize", jobresultssize)
            .queryParam("jobresultsmapfield", jobresultsmapfield)
            .queryParam("valuemappers", valuemappers).request();
   ...
   public WsResult getEntries(String domain, String entries, String fields, boolean fieldurl, boolean viewurl) {
      ...
      Invocation.Builder builder = getTarget().path(path)
            .queryParam("fields", fields)
            .queryParam("fieldurl", fieldurl)
            .queryParam("viewurl", viewurl).request();
   ...
   public WsResult getReferencedEntries(String domain, String entries, String referencedDomain, String fields, int start, int size, boolean fieldurl,
                                        boolean viewurl, int facetCount, String facetfields, String facets, String via) {
    ...
    * @return
    */
   private WsResult getMoreLikeThis(String domain, String entryid, String targetDomain, String fields, int start, int size, boolean fieldurl, boolean viewurl,
                                    String mltfields, int mintermfreq, int mindocfreq, int maxqueryterm, String excludes, String excludesets) {
      ...
      WebTarget t = getTarget().path(path)
            ...
            .queryParam("fieldurl", fieldurl)
            .queryParam("viewurl", viewurl)
            .queryParam("mltfields", mltfields)
            .queryParam("mintermfreq", mintermfreq)
            .queryParam("mindocfreq", mindocfreq)
            .queryParam("maxqueryterm", maxqueryterm)
            .queryParam("excludes", excludes)
            .queryParam("excludesets", excludesets);
    ...
    * @return
    */
   private String getRawdata(String domain, String entryid) {
      printDebugMessage("getRawdata", "Begin", 1);

      String path = domain + "/rawdata/" + entryid;

      WebTarget t = getClientWithoutNamespaceCorrection().target(this.serviceEndPoint).path(path);

      printDebugMessage("getRawdata", getURLString(t), 2);
   ...
   public void printGetFacetedResults(String domain, String query, String fields, int start, int size, boolean fieldurl, boolean viewurl, String sortField,
      ...
      WsResult result = getFacetedResults(domain,
                                          query,
                                          fields,
                                          start,
                                          size,
   ...
   /**
    * Print search results performed against sequence analysis result.
    * @param domain
    * @param toolid
    * @param jobid
    * @param fields
    ...
    * @param selectedfacets
    * @param valuemappers 
    * @param jobresultsmapfield 
    * @param jobresultsstart 
    * @param tooloutputformat 
    */
   public void printGetFacetedResultsFromSequenceAnalysisResults(String domain, String toolid, String jobid, String fields, String query, int start, int size,
                                                                 boolean fieldurl, boolean viewurl, String sortField, String order, String sort, int facetCount,
                                                                 String facetfields, String selectedfacets, int facetsdepth, String tooloutputformat,
                                                                 String jobresultsstart, String jobresultssize, String jobresultsmapfield, String valuemappers) {
      printDebugMessage("printGetFacetedResultsFromSequenceAnalysisResults", "Begin", 1);

      WsResult result = getFacetedResultsFromSequenceAnalysisResults(domain,
                                                                     toolid,
                                                                     jobid,
                                                                     fields,
                                                                     query,
      ...
      printDebugMessage("printGetFacetedResultsFromSequenceAnalysisResults", "End", 1);
   }
   ...
   public void printGetReferencedEntries(String domain, String entryIds, String referencedDomain, String fields, int start, int size, boolean fieldurl,
                                         boolean viewurl, int facetCount, String facetfields, String selectedfacets, String via) {
      printDebugMessage("printGetReferencedEntries", "Begin", 1);

      WsResult result = getReferencedEntries(domain,
                                             entryIds,
                                             referencedDomain,
                                             fields,
                                             start,
    ...
    * @param excludesets
    */
   public void printGetMoreLikeThis(String domain, String entryid, String targetDomain, String fields, int start, int size, boolean fieldurl, boolean viewurl,
                                    String mltfields, int mintermfreq, int mindocfreq, int maxqueryterm, String excludes, String excludesets) {
      printDebugMessage("printGetMoreLikeThis", "Begin", 1);
    ...
    * @param entryid
    */
   public void printGetRawdata(String domain, String entryid) {
      printDebugMessage("printGetRawdata", "Begin", 1);

      String result = getRawdata(domain, entryid);
      System.out.println(result);

      printDebugMessage("printGetRawdata", "End", 1);
   }
   ...
   public static void addCliOptions(Options options) {
      ...
      // --getRawdata <domain> <entryid>
      options.addOption("getRawdata", true, "Get rawdata");
      options.getOption("getRawdata").setArgs(2);

      // --getFacetedResultsFromSequenceAnalysisResults <domain> <toolid> <jobid> <fields>
      options.addOption("getFacetedResultsFromSequenceAnalysisResults", true, "Get search results performed against sequence analysis results");
      options.getOption("getFacetedResultsFromSequenceAnalysisResults").setArgs(4);
      ...
      options.addOption("via", true, "domain ids associated with finding cross-references");

      options.addOption("tooloutputformat", true, "Sequence Tool output format configured in the system");
      options.addOption("jobresultsstart", true, "Sequence Tool results reading start index");
      options.addOption("jobresultssize", true, "Sequence Tool results reading size");
      options.addOption("jobresultsmapfield", true, "Sequence Tool results domain field to map on");
      options.addOption("valuemappers", true, "Comma separated list of 'value mappers' to use on the sequence tool results");
   ...
   public static void main(String[] args) {
      ...
      try {
         ...
         // --getFacetedResults <domain> <query> <fields> [OPTIONS: --size | --start | --fieldurl | --viewurl | --sortfield | --order | --facetcount | --facetfields | --facets]
            ...
            String facetsdepth = cli.hasOption("facetsdepth") ? cli.getOptionValue("facetsdepth") : "1";
         ...
         // --getReferencedEntries <domain> <entryids> <referencedDomain> <fields> [OPTIONS: --size | --start | --fieldurl | --viewurl | --facetcount | --facetfields | --facets | --via ]
            ...
            String facetfield = cli.hasOption("facetfield") ? cli.getOptionValue("facetfield") : "";
            String facets = cli.hasOption("facets") ? cli.getOptionValue("facets") : "";
            String via = cli.hasOption("via") ? cli.getOptionValue("via") : "";
         ...
         // --getRawdata <domain> <entryid>
         else if (cli.hasOption("getRawdata")) {
            String[] vals = cli.getOptionValues("getRawdata");
            ebeye.printGetRawdata(vals[0], vals[1]);
         }

         else if (cli.hasOption("getFacetedResultsFromSequenceAnalysisResults")) {
            String[] vals = cli.getOptionValues("getFacetedResultsFromSequenceAnalysisResults");
            String query = cli.hasOption("query") ? cli.getOptionValue("query") : "";
            String start = cli.hasOption("start") ? cli.getOptionValue("start") : "0";
            String size = cli.hasOption("size") ? cli.getOptionValue("size") : "15";
            String fieldurl = cli.hasOption("fieldurl") ? cli.getOptionValue("fieldurl") : "false";
            String viewurl = cli.hasOption("viewurl") ? cli.getOptionValue("viewurl") : "false";
            ...
            String facets = cli.hasOption("facets") ? cli.getOptionValue("facets") : "";
            String facetsdepth = cli.hasOption("facetsdepth") ? cli.getOptionValue("facetsdepth") : "1";
            String tooloutputformat = cli.hasOption("tooloutputformat") ? cli.getOptionValue("tooloutputformat") : "";
            String jobresultsstart = cli.hasOption("jobresultsstart") ? cli.getOptionValue("jobresultsstart") : "";
            String jobresultssize = cli.hasOption("jobresultssize") ? cli.getOptionValue("jobresultssize") : "";
            String jobresultsmapfield = cli.hasOption("jobresultsmapfield") ? cli.getOptionValue("jobresultsmapfield") : "";
            String valuemappers = cli.hasOption("valuemappers") ? cli.getOptionValue("valuemappers") : "";

            ebeye.printGetFacetedResultsFromSequenceAnalysisResults(vals[0],
                                                                    vals[1],
                                                                    vals[2],
                                                                    vals[3],
                                                                    query,
