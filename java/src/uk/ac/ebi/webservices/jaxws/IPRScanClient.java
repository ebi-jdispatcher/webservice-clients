 ...
 * 
 * ======================================================================
 * InterProScan (SOAP) web service Java client using JAX-WS.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.jaxws.stubs.iprscan.*;

/** InterProScan (SOAP) web service Java client using JAX-WS.
 * 
 * See:
 * <a href="http://www.ebi.ac.uk/Tools/webservices/services/pfa/iprscan">http://www.ebi.ac.uk/Tools/webservices/services/pfa/iprscan</a>
