...
public class EBeyeClient {
	...
	public Facet[] getFacets(String domain, String query)
		...
		List<Facet> facetList = result.getFacet();
		retVal = facetList.toArray(new Facet[0]);
	...
	public void printGetFacets(String domain, String query) 
		...
		for (int i = 0; i < facetList.length; i++) {
			...
			System.out.println(facet.getLabel().getValue() + ":");
			for ( FacetValue facetVal : facet.getFacetValues().getValue().getFacetValue()) {
