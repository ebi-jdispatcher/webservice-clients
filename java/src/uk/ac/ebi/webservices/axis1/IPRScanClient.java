...
/** <p>JDispatcher InterProScan (SOAP) web service Java client using Apache Axis 
 * 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/sss/iprscan_soap">http://www.ebi.ac.uk/Tools/webservices/services/sss/iprscan_soap</a></li>
...
+ "\n";
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("crc")) params.setNocrc(false);
		else if (line.hasOption("nocrc")) params.setNocrc(true);
		if (line.hasOption("goterms")) params.setGoterms(true);
		else if (line.hasOption("nogoterms")) params.setGoterms(false);
