 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS matcher (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.matcher.*;

/** <p>JDispatcher EMBOSS matcher (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_matcher_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_matcher_soap</a></li>
 ...
 * </ul>
 */
public class EmbossMatcherClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	 ...
	 * @param inputData
	 *            Data input. Ignored, input data read from command-line parameters.
	 * @throws ServiceException
	 * @throws IOException
	 */
	public void submitJobFromCli(CommandLine cli, String inputData)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar EmbossMatcher_Axis1.jar --status --jobid "
							+ jobid);
		} else {
