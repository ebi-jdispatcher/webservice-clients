/* $Id$
 * ======================================================================
 * JDispatcher MView (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.mview.*;

/** <p>JDispatcher MView (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/msa/mview_soap">http://www.ebi.ac.uk/Tools/webservices/services/msa/mview_soap</a></li>
 ...
 * </ul>
 */
public class MViewClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "MView\n"
		+ "=====\n"
		+ "\n"
		+ "Colurise and reformat a multiple sequence alignment or a sequence \n"
		+ "similairity search (SSS) report\n"
		+ "\n"
		+ "[Required]\n"
		+ "\n"
	...
	public static void main(String[] args) {
		...
		options.addOption("ruler", false, "show ruler");
		options.addOption("noruler", false, "hide ruler");
		options.addOption("width", true, "output alignment width");
		options.addOption("coloring", true, "colouring style");
		options.addOption("colormap", true, "colour map");
		options.addOption("groupmap", true, "group map");
		options.addOption("consensus", false, "show consensus");
		options.addOption("noconsensus", false, "hide consensus");
		options.addOption("concoloring", true, "colouring style for consensus");
		options.addOption("concolormap", true, "colour map for consensus");
		options.addOption("congroupmap", true, "group map for consensus");
		options.addOption("congaps", false, "include gaps in consensus");
		options.addOption("nocongaps", false, "exclude gaps in consensus");
		options.addOption("sequence", true, "Input alignment data");

		CommandLineParser cliParser = new GnuParser(); // Create the command line parser    
		// Create an instance of the client
		MViewClient client = new MViewClient();
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar MView_Axis1.jar --status --jobid " + jobid);
				} else {
