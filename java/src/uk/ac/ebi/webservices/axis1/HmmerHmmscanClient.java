 ...
 * 
 * ======================================================================
 * JDispatcher HMMER hmmscan (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.hmmer.hmmscan.*;

/**
 * <p>
 * JDispatcher HMMER hmmscan (SOAP) web service Java client using Apache Axis
 * 1.x.
 * </p>
 * 
 * <p>
 ...
 * <ul>
 * <li><a
 * href="http://www.ebi.ac.uk/Tools/webservices/services/sss/hmmer_hmmscan_soap"
 * >http://www.ebi.ac.uk/Tools/webservices/services/sss/hmmer_hmmscan_soap</a></li>
 * <li><a
 ...
 * </ul>
 */
public class HmmerHmmscanClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	/** Service proxy */
	private JDispatcherService_PortType srvProxy = null;
	/** Client version/revision */
	private String revision = "$Revision$";
	/** Tool specific usage message */
	private static final String usageMsg = "HMMER hmmscan"
+ "=============\n"
+ "\n"
...
+ "                              sequences.\n";
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("cutoffOption"))
			params.setCutoffOption(line.getOptionValue("cutoffOption"));
		if (line.hasOption("cut_ga"))
			params.setCutoffOption("ga-score");
		if (line.hasOption("E")) {
			params.setCutoffOption("e-value");
			params.setEvalue(new Double(line.getOptionValue("E")));
		}
	...
	public static void main(String[] args) {
		...
		options.addOption("cut_ga", "cut_ga", false, "GA thresholds.");
		...
		HmmerHmmscanClient client = new HmmerHmmscanClient();
		try {
