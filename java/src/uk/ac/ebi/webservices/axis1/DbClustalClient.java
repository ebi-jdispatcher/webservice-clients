/* $Id$
 * ======================================================================
 * JDispatcher DbClustal (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.dbclustal.*;

/** <p>JDispatcher DbClustal (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/msa/dbclustal_soap">http://www.ebi.ac.uk/Tools/webservices/services/msa/dbclustal_soap</a></li>
 ...
 * </ul>
 */
public class DbClustalClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "DbClustal\n"
		+ "=========\n"
		+ "\n"
	...
	public static void main(String[] args) {
		...
		DbClustalClient client = new DbClustalClient();
		try {
