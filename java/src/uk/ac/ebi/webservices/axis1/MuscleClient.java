 ...
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/sss/muscle_soap">http://www.ebi.ac.uk/Tools/webservices/services/sss/muscle_soap</a></li>
		...
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar Muscle_Axis1.jar --status --jobid " + jobid);
				} else {
