/* $Id$
 * ======================================================================
 * JDispatcher EMBOSS backtranambig (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.backtranambig.*;

/** <p>JDispatcher EMBOSS backtranambig (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_backtranambig_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_backtranambig_soap</a></li>
 ...
 * </ul>
 */
public class EmbossBacktranambigClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS backtranambig\n"
		+ "================\n"
		+ "\n"
	...
	/** Default constructor.
	 */
	public EmbossBacktranambigClient() {
		...
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar EmbossBacktranambig_Axis1.jar --status --jobid " + jobid);
				} else {
