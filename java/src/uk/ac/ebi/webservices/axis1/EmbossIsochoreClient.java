 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS isochore (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.isochore.*;

/** <p>JDispatcher EMBOSS isochore (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_isochore_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_isochore_soap</a></li>
 ...
 * </ul>
 */
public class EmbossIsochoreClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS isochore\n"
			+ "===============\n"
			+ "\n"
			...
			+ "[Optional]\n"
			+ "\n"
			+ "      --shift         : int  : shift increment.\n"
			+ "      --window        : int  : windows size.\n"
			+ "      --multifasta    :      : treat input as a set of fasta formatted sequences\n";

	/** Default constructor.
	 */
	public EmbossIsochoreClient() {
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("shift")) params.setShift(new Integer(line.getOptionValue("shift")));
	...
	public String submitJobFromCli(CommandLine cli, String inputSeq)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar EmbossIsochore_Axis1.jar --status --jobid "
							+ jobid);
		}
	...
	public static void main(String[] args) {
		...
		options.addOption("shift", true, "shift increment.");	
		options.addOption("window", true, "windows size.");	
		...
		EmbossIsochoreClient client = new EmbossIsochoreClient();
		try {
