 ...
 * 
 * ======================================================================
 * JDispatcher PromoterWise (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.promoterwise.*;

/** <p>JDispatcher PromoterWise (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/promoterwise_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/promoterwise_soap</a></li>
 ...
 * </ul>
 */
public class PromoterWiseClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "PromoterWise\n"
		+ "==============\n"
		+ "\n"
		+ "PromoterWise compares two DNA sequences allowing for inversions and\n" 
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("hitoutput")) params.setHitoutput(line.getOptionValue("hitoutput"));
		// Input data.
	 ...
	 * @param inputData
	 *            Data input. Ignored, input data via command-line options.
	 * @throws ServiceException
	 * @throws IOException
	 */
	public void submitJobFromCli(CommandLine cli, String inputData)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar PromoterWise_Axis1.jar --status --jobid "
							+ jobid);
		} else {
	...
	public static void main(String[] args) {
		...
		options.addOption("hitoutput", true, "Hit list output format");
		...
		PromoterWiseClient client = new PromoterWiseClient();
		try {
