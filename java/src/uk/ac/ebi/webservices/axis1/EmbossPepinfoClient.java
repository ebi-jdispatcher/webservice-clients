/* $Id$
 * ======================================================================
 * JDispatcher EMBOSS pepinfo (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.pepinfo.*;

/** <p>JDispatcher EMBOSS pepinfo (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/stat/emboss_pepinfo_soap">http://www.ebi.ac.uk/Tools/webservices/services/stat/emboss_pepinfo_soap</a></li>
 ...
 * </ul>
 */
public class EmbossPepinfoClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS Pepinfo\n"
		+ "================\n"
		+ "\n"
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("hwindow"))
		{
			Integer hwindow = Integer.valueOf(line.getOptionValue("hwindow"));
			
			params.setHwindow(hwindow);
	...
	public static void main(String[] args) {
		...
		options.addOption("hwindow", true, "Window size");
		...
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar EmbossPepinfo_Axis1.jar --status --jobid " + jobid);
				} else {
