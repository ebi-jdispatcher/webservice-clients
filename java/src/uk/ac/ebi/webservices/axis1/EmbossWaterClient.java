 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS water (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.water.*;

/** <p>JDispatcher EMBOSS water (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_water_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_water_soap</a></li>
 ...
 * </ul>
 */
public class EmbossWaterClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS water\n"
		+ "==============\n"
		+ "\n"
	 ...
	 * @param inputData
	 *            Data input. Ignored, input via command-line options.
	 * @throws ServiceException
	 * @throws IOException
	 */
