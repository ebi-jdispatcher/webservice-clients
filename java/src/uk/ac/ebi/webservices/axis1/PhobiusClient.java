 ...
 * </ul>
 */
public class PhobiusClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	/** Service proxy */
	...
	public String submitJobFromCli(CommandLine cli, String inputSeq)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar Phobius_Axis1.jar --status --jobid "
							+ jobid);
		}
	...
	public static void main(String[] args) {
		...
		PhobiusClient client = new PhobiusClient();
		try {
