/* $Id$
 * ======================================================================
 * JDispatcher Radar (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.radar.*;

/** <p>JDispatcher RADAR (SOAP) web service Java client using Apache Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/pfa/radar_soap">http://www.ebi.ac.uk/Tools/webservices/services/pfa/radar_soap</a></li>
 ...
 * </ul>
 */
public class RadarClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "RADAR\n"
		+ "================\n"
		+ "\n"
		+ "Identify short composition biased as well as gapped approximate repeats and complex repeat architectures.\n"
		+ "\n"    
		+ "[Required]\n"
		+ "\n"
		...
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar Radar_Axis1.jar --status --jobid " + jobid);
				} else {
