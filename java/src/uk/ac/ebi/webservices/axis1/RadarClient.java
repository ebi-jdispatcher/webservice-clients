...
public class RadarClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "RADAR\n"
		+ "================\n"
		+ "\n"
		+ "Identify short composition biased as well as gapped approximate repeats and \n"
		+ "complex repeat architectures.\n"
		+ "\n"    
		+ "[Required]\n"
		+ "\n"
	...
	public String submitJobFromCli(CommandLine cli, String inputSeq)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar Radar_Axis1.jar --status --jobid "
							+ jobid);
		} else {
