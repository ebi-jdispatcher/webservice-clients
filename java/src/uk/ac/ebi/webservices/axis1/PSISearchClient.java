...
import uk.ac.ebi.webservices.axis1.stubs.psisearch.*;

/** <p>JDispatcher PSI-Search (SOAP) web service Java client using Apache Axis 
 * 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/sss/psisearch_soap">http://www.ebi.ac.uk/Tools/webservices/services/sss/psisearch_soap</a></li>
 ...
 * </ul>
 */
public class PSISearchClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "PSI-Search\n"
		+ "==========\n"
		+ "\n"
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Submit a job
				...
				if(cli.hasOption("selectedHits")) params.setSelectedHits(client.loadData(cli.getOptionValue("selectedHits")));
				if(cli.hasOption("R")) params.setCpfile(client.loadData(cli.getOptionValue("R")));
				// Submit the job
