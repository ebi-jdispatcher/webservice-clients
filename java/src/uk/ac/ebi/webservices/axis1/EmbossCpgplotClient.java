 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS cpgplot (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.cpgplot.*;

/** <p>JDispatcher EMBOSS cpgplot (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_cpgplot_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_cpgplot_soap</a></li>
 ...
 * </ul>
 */
public class EmbossCpgplotClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS cpgplot\n"
			+ "==============\n"
			+ "\n"
	...
	public String submitJobFromCli(CommandLine cli, String inputSeq)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar EmbossCpgplot_Axis1.jar --status --jobid "
							+ jobid);
		}
	...
	public static void main(String[] args) {
		...
		EmbossCpgplotClient client = new EmbossCpgplotClient();
		try {
