 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS stretcher (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.stretcher.*;

/** <p>JDispatcher EMBOSS stretcher (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_stretcher_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_stretcher_soap</a></li>
 ...
 * </ul>
 */
public class EmbossStretcherClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS stretcher\n"
		+ "================\n"
		+ "\n"
	 ...
	 * @param inputData
	 *            Data input. Ignored, data read via command-line.
	 * @throws ServiceException
	 * @throws IOException
	 */
	public String submitJobFromCli(CommandLine cli, String inputData)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar EmbossStretcher_Axis1.jar --status --jobid "
							+ jobid);
		} else {
