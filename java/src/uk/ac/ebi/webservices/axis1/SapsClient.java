/* $Id$
 * ======================================================================
 * JDispatcher SAPS (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.saps.*;

/** <p>JDispatcher SAPS (SOAP) web service Java client using Apache Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/stat/saps_soap">http://www.ebi.ac.uk/Tools/webservices/services/stat/saps_soap</a></li>
 ...
 * </ul>
 */
public class SapsClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "SAPS\n"
		+ "================\n"
		+ "\n"
		...
		+ "[Optional]\n"
		+ "\n"
		+ "      --species         : str  : use the specified species table for quantile comparisons, see\n"
		+ "                                 --paramDetail species\n"
		+ "      --positiveresidues: str  : positive Residues, see\n"
		+ "                                 --paramDetail positiveresidues\n"
		+ "      --outputtype      : str  : output type\n"
		+ "                                 --paramDetail outputtype\n";
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("species")) params.setSpecies(line.getOptionValue("species"));
		if (line.hasOption("positiveresidues")) params.setPositiveresidues(line.getOptionValue("positiveresidues"));
		if (line.hasOption("outputtype")) params.setOutputtype(line.getOptionValue("outputtype"));
	...
	public static void main(String[] args) {
		...
		options.addOption("species", true, "The frames to be translated");
		options.addOption("positiveresidues", true, "Codon Table");
		options.addOption("outputtype", true, "Regions to be translated");
		...
		SapsClient client = new SapsClient();
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar Saps_Axis1.jar --status --jobid " + jobid);
				} else {
