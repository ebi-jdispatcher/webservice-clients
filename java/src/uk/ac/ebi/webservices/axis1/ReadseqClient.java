...
public class ReadseqClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "Readseq\n"
		...
		+ "[Optional]\n"
		+ "\n"
		+ "      --inputformat    : int  : input sequence format, see --paramDetail \n"
		+ "                                inputformat\n"
		+ "      --outputformat   : int  : output sequence format, see --paramDetail \n"
		+ "                                outputformat\n"
		+ "      --outputcase     : str  : output sequence character case, see \n"
		+ "                                --paramDetail outputcase\n"
		+ "      --reverse        :      : reverse-complement nucleotide sequence\n"
		+ "      --noreverse      :      : don't reverse-complement nucleotide sequence\n"
		...
		+ "                                sign separated: see --paramDetail feature\n"
	...
	public String submitJobFromCli(CommandLine cli, String inputSeq)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar Readseq_Axis1.jar --status --jobid "
							+ jobid);
		}
