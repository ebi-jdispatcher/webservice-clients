 ...
 * 
 * ======================================================================
 * JDispatcher FingerPRINTScan (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.fingerprintscan.*;

/** <p>JDispatcher FingerPRINTScan (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/msa/fingerprintscan_soap">http://www.ebi.ac.uk/Tools/webservices/services/msa/fingerprintscan_soap</a></li>
 ...
 * </ul>
 */
public class FingerPRINTScanClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "FingerPRINTScan\n"
		...
		+ "  --evalue             : real : expectation value threshold, \n"
	...
	public String submitJobFromCli(CommandLine cli, String inputSeq)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar FingerPRINTScan_Axis1.jar --status --jobid "
							+ jobid);
		}
	...
	public static void main(String[] args) {
		...
		options.addOption("matrix", true, "The data matrix to search");		
		options.addOption("evalue", true, "Expectation value threshold");
		options.addOption("distdev", true, "Distance deviation");
		options.addOption("resultviews", true, "Output result views");
		...
		FingerPRINTScanClient client = new FingerPRINTScanClient();
		try {
