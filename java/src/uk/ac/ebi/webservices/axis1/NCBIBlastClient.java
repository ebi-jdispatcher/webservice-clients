...
public class NCBIBlastClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	 ...
	 * 
	 * <p>
	 * <b>Note</b>: this affects all java.net based requests, but not the Axis
	 * requests. The user-agent used by Axis is set from the
	 * /org/apache/axis/i18n/resource.properties file included in the JAR.
	 * </p>
	 */
	private void setUserAgent() {
		printDebugMessage("setUserAgent", "Begin", 1);
		// Java web calls use the http.agent property as a prefix to the default
		// user-agent.
		String clientVersion = this.revision.substring(11, this.revision
				.length() - 2);
	...
	public InputParameters loadParams(CommandLine line) throws IOException {
		...
		if (line.hasOption("u") && line.hasOption("v")) {
			params.setMatch_scores(line.getOptionValue("u") + ","
	...
	public static void main(String[] args) {
		...
		options.addOption("n", "alignments", true,
				"Maximum number of alignments to display");
