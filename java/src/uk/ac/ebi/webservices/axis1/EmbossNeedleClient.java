 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS needle (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.emboss.needle.*;

/** <p>JDispatcher EMBOSS needle (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_needle_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_needle_soap</a></li>
 ...
 * </ul>
 */
public class EmbossNeedleClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS needle\n"
		+ "=============\n"
		+ "\n"
		...
		+ "  -x, --gapextend     : real : gap extension penalty\n"
	 ...
	 * @param inputData
	 *            Data input. Ignored, input data obtained via command-line.
	 * @throws ServiceException
	 * @throws IOException
	 */
	public void submitJobFromCli(CommandLine cli, String inputData)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar EmbossNeedle_Axis1.jar --status --jobid "
							+ jobid);
		} else {
	...
	public static void main(String[] args) {
		...
		options.addOption("x", "gapextend", true, "Gap extension penalty");
		options.addOption("endweight", false, "Enable end gap penalties");
		options.addOption("endopen", true, "End gap open penalty");
		options.addOption("endextend", true, "End gap extension penalty");
