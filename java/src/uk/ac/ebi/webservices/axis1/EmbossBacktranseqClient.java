...
import uk.ac.ebi.webservices.axis1.stubs.emboss.backtranseq.*;

/** <p>JDispatcher EMBOSS backtranseq (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_backtranseq_soap">http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_backtranseq_soap</a></li>
 ...
 * </ul>
 */
public class EmbossBacktranseqClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "EMBOSS backtranseq\n"
		...
		+ "[Optional]\n"
		+ "\n"
		+ "      --codontable   : str  : codon usage table name, see --paramDetail \n"
		+ "                              codontable\n"; 
	...
	public static void main(String[] args) {
		...
		options.addOption("codontable", true, "Codon usage table name");	
		...
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar EmbossBacktranseq_Axis1.jar --status --jobid " + jobid);
				} else {
