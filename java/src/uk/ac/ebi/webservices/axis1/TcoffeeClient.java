/* $Id$
 * ======================================================================
 * JDispatcher T-COFFEE (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.tcoffee.*;

/** <p>JDispatcher T-COFFEE (SOAP) web service Java client using Apache 
 * Axis 1.x.</p>
 * 
 * <p>See:</p>
 * <ul>
 * <li><a href="http://www.ebi.ac.uk/Tools/webservices/services/msa/tcoffee_soap">http://www.ebi.ac.uk/Tools/webservices/services/msa/tcoffee_soap</a></li>
 ...
 * </ul>
 */
public class TcoffeeClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
	...
	private static final String usageMsg = "T-COFFEE\n"
		+ "========\n"
		+ "\n"
		+ "[Required]\n"
		+ "\n"
	...
	public static void main(String[] args) {
		...
		TcoffeeClient client = new TcoffeeClient();
		try {
			...
			// Submit a job
				...
				if (cli.hasOption("async")) {
					...
					System.err.println("To get status: java -jar Tcoffee_Axis1.jar --status --jobid " + jobid);
				} else {
