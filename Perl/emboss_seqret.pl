...
[Optional]
  --stype               : str  : Indicates if the query sequence is protein, DNA or RNA.
  --inputformat         : str  : Input format name
  --outputformat        : str  : Output format name.
  --feature             : bool : Use feature information
  --firstonly           : bool : Read one sequence and stop
  --reverse             : bool : Reverse-complement of input DNA sequences
  --outputcase          : str  : Change alphabet case for output sequences.
  ...
  --sequence            : ali  : One or more sequences to be translated can be entered directly into
