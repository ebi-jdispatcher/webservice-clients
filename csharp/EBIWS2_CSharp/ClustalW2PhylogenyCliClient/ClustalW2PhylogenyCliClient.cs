...
using System;
using System.IO;
using EbiWS.ClustalW2PhylogenyWs;

namespace EbiWS
{
	class ClustalW2PhylogenyCliClient : EbiWS.ClustalW2PhylogenyClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"ClustalW2 Phylogeny
===================
...
";
		...
		public static int Main(string[] args)
		{
			...
			ClustalW2PhylogenyCliClient wsApp = new ClustalW2PhylogenyCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "--tree": // Output tree format.
					InParams.tree = args[++i];
					break;
				case "/tree":
					goto case "--tree";
				case "-t":
				...
				case "/t":
					goto case "--tree";
				case "--kimura": // Kimura's distance correction
					InParams.kimura = true;
					InParams.kimuraSpecified = true;
					break;
				case "/kimura":
					goto case "--kimura";
				case "--K": 
				...
				case "/K":
					goto case "--kimura";
				case "--tossgaps": // Exculde gaps
					InParams.tossgaps = true;
					InParams.tossgapsSpecified = true;
					break;
				case "/tossgaps":
					goto case "--tossgaps";
				case "-I":
				...
				case "/I":
					goto case "--tossgaps";
				case "--clustering": // Clustering method.
