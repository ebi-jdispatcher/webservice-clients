/* $Id$
 * ======================================================================
 * jDispatcher EMBOSS backtranambig (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossBacktranambigWs;

namespace EbiWS
{
	class EmbossBacktranambigCliClient : EbiWS.EmbossBacktranambigClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS backtranambig
================

Global pairwise sequence alignment using EMBOSS backtranambig.
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossBacktranambigCliClient wsApp = new EmbossBacktranambigCliClient();
