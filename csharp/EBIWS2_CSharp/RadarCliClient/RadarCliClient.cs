 ...
 * 
 * ======================================================================
 * jDispatcher SOAP command-line client for Radar
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.RadarWs;
...
namespace EbiWS
{
	class RadarCliClient : EbiWS.RadarClient
	{
...
[Required]
  ...
  seqFile           : file : query sequence
                      (""-"" for STDIN, @filename for identifier list file)
";
		...
		public static int Main(string[] args)
		{
			...
			RadarCliClient wsApp = new RadarCliClient();
