 ...
 * 
 * ======================================================================
 * jDispatcher MapMi (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.MapMiWs;
...
namespace EbiWS
{
	class MapMiCliClient : EbiWS.MapMiClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"MapMi
=====
...
";
		...
		public static int Main(string[] args)
		{
			...
			MapMiCliClient wsApp = new MapMiCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				switch (args[i])
				{
					...
					// TODO: add tool specific options.
