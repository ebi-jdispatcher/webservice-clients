 ...
 * 
 * ======================================================================
 * jDispatcher EMBOSS backtranseq (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossBacktranseqWs;

namespace EbiWS
{
	class EmbossBacktranseqCliClient : EbiWS.EmbossBacktranseqClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS backtranseq
================

Global pairwise sequence alignment using EMBOSS backtranseq.
...
[Optional]
  ...
  --codontable   : str  : codon usage table name, see --paramDetail codontable
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossBacktranseqCliClient wsApp = new EmbossBacktranseqCliClient();
