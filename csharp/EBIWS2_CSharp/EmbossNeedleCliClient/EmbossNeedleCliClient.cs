/* $Id$
 * ======================================================================
 * jDispatcher EMBOSS needle (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossNeedleWs;

namespace EbiWS
{
	class EmbossNeedleCliClient : EbiWS.EmbossNeedleClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS needle
=============
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossNeedleCliClient wsApp = new EmbossNeedleCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "/endweight":
					goto case "--endweight";
				case "--endopen": // Gap open penalty for end gap.
					InParams.endopen = Convert.ToSingle(args[++i]);
					InParams.endopenSpecified = true;
					break;
				case "/endopen":
					goto case "--endopen";
				case "--endextend": // Gap extension penalty for end gap.
					InParams.endextend = Convert.ToSingle(args[++i]);
					InParams.endextendSpecified = true;
					break;
				case "/endextend":
					goto case "--endextend";
