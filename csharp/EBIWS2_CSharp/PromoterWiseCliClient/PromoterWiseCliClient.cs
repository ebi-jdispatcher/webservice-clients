 ...
 * 
 * ======================================================================
 * JDispatcher PromoterWise (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.PromoterWiseWs;

namespace EbiWS
{
	class PromoterWiseCliClient : EbiWS.PromoterWiseClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"promoterwise
======
...
";
		...
		public static int Main(string[] args)
		{
			...
			PromoterWiseCliClient wsApp = new PromoterWiseCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "--hitoutput": // Output format.
					InParams.hitoutput = args[++i];
					break;
				case "/hitoutput":
					goto case "--hitoutput";
				case "-o":
