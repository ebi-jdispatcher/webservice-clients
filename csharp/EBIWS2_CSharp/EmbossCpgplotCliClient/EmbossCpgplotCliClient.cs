 ...
 * 
 * ======================================================================
 * jDispatcher EMBOSS cpgplot (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossCpgplotWs;

namespace EbiWS
{
	class EmbossCpgplotCliClient : EbiWS.EmbossCpgplotClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS cpgplot
==============
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossCpgplotCliClient wsApp = new EmbossCpgplotCliClient();
