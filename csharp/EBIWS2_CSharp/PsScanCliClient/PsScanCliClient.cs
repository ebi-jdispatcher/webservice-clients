 ...
 * 
 * ======================================================================
 * jDispatcher SOAP command-line client for PROSITE Scan (SOAP).
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.PsScanWs;

namespace EbiWS
{
	class PsScanCliClient : EbiWS.PsScanClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"PROSITE Scan
=============
...
";
		...
		public static int Main(string[] args)
		{
			...
			PsScanCliClient wsApp = new PsScanCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				switch (args[i])
				{
					...
					case "/format":
						goto case "--format";
					case "--database": // Database to scan
						InParams.database = args[++i];
						break;
					case "/database":
						goto case "--database";
					case "--scanControl": // Scan Patterns and/or Profiles
						InParams.scanControl = args[++i];
						break;
					case "/scanControl":
						goto case "--scanControl";
					case "--commonMatch": // Enable common Matches Reporting
						InParams.commonMatch = true;
						InParams.commonMatchSpecified = true;
						break;
					case "/commonMatch":
						goto case "--commonMatch";
					case "--noCommonMatch": // Disable common Matches Reporting
						InParams.commonMatch = false;
						InParams.commonMatchSpecified = true;
						break;
					case "/noCommonMatch":
						goto case "--noCommonMatch";
					case "--overlappingMatch": // Enable overlapping Matches Reporting
						InParams.overlappingMatch = true;
						InParams.overlappingMatchSpecified = true;
						break;
					case "/overlappingMatch":
						goto case "--overlappingMatch";
					case "--noOverlappingMatch": // Disable overlapping Matches Reporting
						InParams.overlappingMatch = false;
						InParams.overlappingMatchSpecified = true;
						break;
					case "/noOverlappingMatch":
						goto case "--noOverlappingMatch";	
					case "--profileThreshold": // Cut-off level for profiles
						InParams.profileThreshold = Convert.ToInt32(args[++i]);
						InParams.profileThresholdSpecified = true;
						break;
					case "/profileThreshold":
						goto case "--profileThreshold";
