/* $Id$
 * ======================================================================
 * JDispatcher SOAP client for MUSCLE
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/msa/muscle_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.MuscleWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI MUSCLE SOAP web service.
	/// </summary>
	public class MuscleClient : EbiWS.AbstractWsClient
	{
