 ...
 * 
 * ======================================================================
 * JDispatcher Dalilite (SOAP) web service .NET/Mono client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.DaliliteWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI Dalilite (SOAP) web service.
	/// </summary>	
	public class DaliliteClient : EbiWS.AbstractWsClient
	{
