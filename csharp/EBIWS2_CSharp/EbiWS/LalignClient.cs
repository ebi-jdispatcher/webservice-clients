 ...
 * 
 * ======================================================================
 * JDispatcher lalign (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.LalignWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI lalign (SOAP) web service.
	/// </summary>	
	public class LalignClient : EbiWS.AbstractWsClient
	{
