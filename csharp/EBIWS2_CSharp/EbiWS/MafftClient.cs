 ...
 * 
 * ======================================================================
 * JDispatcher SOAP client for MAFFT
 *
 * See:
...
using System;
using System.IO;
using EbiWS.MafftWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI MAFFT SOAP web service.
	/// </summary>
	public class MafftClient : EbiWS.AbstractWsClient
	{
