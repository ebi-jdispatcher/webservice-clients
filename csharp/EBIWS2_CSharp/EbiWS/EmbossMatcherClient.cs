 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS matcher (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.EmbossMatcherWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS matcher (SOAP) web service.
	/// </summary>	
	public class EmbossMatcherClient : EbiWS.AbstractWsClient
	{
