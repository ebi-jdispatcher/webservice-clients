...
///</remarks>
        ...
        /// <remarks>
///PSI-Search threshold [Expectation value threshold for automatic selection of matched sequences for inclusion in PSSM at each iteration.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true, DataType="double")]
...
///</remarks>
        ...
        /// <remarks>
///Previous Iteration Job Id [The job identifier for the previous PSI-Search iteration.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public string previousjobid;
        
        /// <remarks>
///Selected Hits [ist of identifiers of the hits from the previous iteration to use to construct the search PSSM for this iteration.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
