...
namespace EbiWS.NcbiBlastWs {
    ...
    public partial class JDispatcherService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public JDispatcherService() {
            this.Url = "http://www.ebi.ac.uk/Tools/services/soap/ncbiblast";
        }
    ...
    public partial class InputParameters {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable=true)]
        public string compstats {
            get {
                return this.compstatsField;
            }
            set {
                this.compstatsField = value;
            }
        }
