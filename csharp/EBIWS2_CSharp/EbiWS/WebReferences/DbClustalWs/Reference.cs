...
namespace EbiWS.DbClustalWs {
    ...
    public partial class JDispatcherService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public JDispatcherService() {
            this.Url = "http://www.ebi.ac.uk/Tools/services/soap/dbclustal";
        }
...
///</remarks>
        ...
        /// <remarks>
///BLAST output file upload [NCBI BLAST or WU-BLAST output format file for input]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public byte[] upblastfile;
        
        /// <remarks>
///ID listfile upload [ID list file for input]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public byte[] upidlistfile;
    }
