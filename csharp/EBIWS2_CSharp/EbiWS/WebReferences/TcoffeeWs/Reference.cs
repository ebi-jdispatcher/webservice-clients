...
namespace EbiWS.TcoffeeWs {
    ...
    public partial class JDispatcherService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public JDispatcherService() {
            this.Url = "http://www.ebi.ac.uk/Tools/services/soap/tcoffee";
        }
...
///</remarks>
    ...
    public partial class InputParameters {
        ...
        /// <remarks>
///Matrix [Matrix series to use when generating the multiple sequence alignment. The program goes through the chosen matrix series, spanning the full range of amino acid distances.]
///</remarks>
