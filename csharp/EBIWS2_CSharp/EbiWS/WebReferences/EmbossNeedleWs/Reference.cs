...
///</remarks>
        ...
        /// <remarks>
///Gap open [Pairwise alignment score for the first residue in a gap.]
///</remarks>
        ...
        /// <remarks>
///Gap extend [Pairwise alignment score for each additional residue in a gap.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true, DataType="float")]
        ...
        /// <remarks>
///End Gap Penalty [Apply end gap penalty]
///</remarks>
        ...
        /// <remarks>
///End Gap Open Penalty [Score taken away when an end gap is created.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true, DataType="float")]
        ...
        /// <remarks>
///End Gap Extension Penalty [Penalty is added to the end gap penalty for each base or residue in the end gap. This is how long end gaps are penalized.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true, DataType="float")]
        ...
        /// <remarks>
///Output Format [Pairwise sequences format]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public string format;
        
        /// <remarks>
///Sequence Type [Defines the type of the sequences to be aligned]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public string stype;
        
        /// <remarks>
///First Sequence [A free text (raw) list of sequences is simply a block of characters representing several DNA/RNA or Protein sequences. A sequence can be be in GCG, FASTA, EMBL, GenBank, PIR, NBRF, Phylip or UniProtKB/Swiss-Prot format. Partially formatted sequences are not accepted. Adding a return to the end of the sequence may help certain applications understand the input. Note that directly using data from word processors may yield unpredictable results as hidden/control characters may be present.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public string asequence;
        
        /// <remarks>
///Second Sequence [A free text (raw) list of sequences is simply a block of characters representing several DNA/RNA or Protein sequences. A sequence can be be in GCG, FASTA, EMBL, GenBank, PIR, NBRF, Phylip or UniProtKB/Swiss-Prot format. Partially formatted sequences are not accepted. Adding a return to the end of the sequence may help certain applications understand the input. Note that directly using data from word processors may yield unpredictable results as hidden/control characters may be present.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
