...
namespace EbiWS.KalignWs {
    ...
    public partial class JDispatcherService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public JDispatcherService() {
            this.Url = "http://www.ebi.ac.uk/Tools/services/soap/kalign";
        }
...
///</remarks>
        ...
        /// <remarks>
///Gap Open Penalty [The penalty for opening/closing a gap. Half the value will be subtracted from the alignment score when opening, and half when closing a gap.]
///</remarks>
...
///</remarks>
        ...
        /// <remarks>
///Terminal Gap Penalties [Penalty to extend gaps from the N/C terminal of protein or 5'/3' terminal of nucleotide sequences]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true, DataType="float")]
        public System.Nullable<float> termgap;
        
        /// <remarks/>
        [System.Xml.Serialization.XmlIgnore()]
        public bool termgapSpecified;
        
        /// <remarks>
///Bonus Score [A bonus score that is added to each pair of aligned residues]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true, DataType="float")]
        public System.Nullable<float> bonus;
