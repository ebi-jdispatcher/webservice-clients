...
namespace EbiWS.SeqCksumWs {
    ...
    public partial class JDispatcherService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public JDispatcherService() {
            this.Url = "http://www.ebi.ac.uk/Tools/services/soap/seqcksum";
        }
...
///</remarks>
    ...
    public partial class InputParameters {
        ...
        /// <remarks>
///Sequence Type [Indicates if the sequences are protein or nucleotide (DNA/RNA).]
///</remarks>
        public string stype;
        
        /// <remarks/>
        [System.Xml.Serialization.XmlArray(IsNullable=true)]
        public string[] cksmethod;
        
        /// <remarks>
///Display of sequence length [Turn on/off the display of asequence length.]
///</remarks>
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true, DataType="boolean")]
        public System.Nullable<bool> length;
