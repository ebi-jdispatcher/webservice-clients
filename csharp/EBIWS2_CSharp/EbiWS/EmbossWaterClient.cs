/* $Id$
 * ======================================================================
 * JDispatcher EMBOSS water (SOAP) client.
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_water_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossWaterWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS water (SOAP) web service.
	/// </summary>	
	public class EmbossWaterClient : EbiWS.AbstractWsClient
	{
