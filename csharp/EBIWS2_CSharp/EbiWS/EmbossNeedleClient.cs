 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS needle (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.EmbossNeedleWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS needle (SOAP) web service.
	/// </summary>	
	public class EmbossNeedleClient : EbiWS.AbstractWsClient
	{
