 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS stretcher (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.EmbossStretcherWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS stretcher (SOAP) web service.
	/// </summary>	
	public class EmbossStretcherClient : EbiWS.AbstractWsClient
	{
