/* $Id: EmbossPepwindowClient.cs 2065 2011-12-09 11:38:13Z wli $
 * ======================================================================
 * 
 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS pepwindow (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.EmbossPepwindowWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS pepwindow (SOAP) web service.
	/// </summary>	
	public class EmbossPepwindowClient : EbiWS.AbstractWsClient
	{
