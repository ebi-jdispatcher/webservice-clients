/* $Id: EmbossPepinfoClient.cs 2065 2011-12-09 11:38:13Z wli $
 * ======================================================================
 * 
 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS pepinfo (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.EmbossPepinfoWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS pepinfo (SOAP) web service.
	/// </summary>	
	public class EmbossPepinfoClient : EbiWS.AbstractWsClient
	{
