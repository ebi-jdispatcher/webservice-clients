 ...
 * 
 * ======================================================================
 * JDispatcher SOAP client for CENSOR (SOAP)
 * 
 * See:
...
using System;
using System.IO;
using EbiWS.CensorWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI CENSOR SOAP web service.
	/// </summary>
	public class CensorClient : EbiWS.AbstractWsClient
	{
