/* $Id$
 * ======================================================================
 * JDispatcher SOAP client for PSI-BLAST
 * 
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/psiblast_soap
...
{
	/// <summary>
	/// Client for EMBL-EBI PSI-BLAST SOAP web service.
	/// </summary>
	public class PsiBlastClient : EbiWS.AbstractWsClient
	{
