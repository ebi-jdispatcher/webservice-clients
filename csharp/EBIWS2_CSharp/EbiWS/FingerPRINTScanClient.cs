 ...
 * 
 * ======================================================================
 * JDispatcher SOAP client for FingerPRINTScan
 * 
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/fingerprintscan_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.FingerPRINTScanWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI FingerPRINTScan SOAP web service.
	/// </summary>
	public class FingerPRINTScanClient : EbiWS.AbstractWsClient
	{
