 ...
 * 
 * ======================================================================
 * JDispatcher HMMER hmmscan (SOAP) client.
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/psa/hmmer_hmmscan_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.HmmerHmmscanWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI HMMER hmmscan (SOAP) web service.
	/// </summary>	
	public class HmmerHmmscanClient : EbiWS.AbstractWsClient
	{
		...
		private string revision = "$Revision: 2606 $";
