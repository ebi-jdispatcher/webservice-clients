/* $Id$
 * ======================================================================
 * JDispatcher SOAP client for Phobius
 * 
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/phobius_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.PhobiusWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI Phobius SOAP web service.
	/// </summary>
	public class PhobiusClient : EbiWS.AbstractWsClient
	{
