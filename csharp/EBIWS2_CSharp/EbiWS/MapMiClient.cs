 ...
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/pfa/mapmi_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.MapMiWs; // "Web Reference" or wsdl.exe generated stubs.
...
namespace EbiWS
{
	...
	/// </summary>
	public class MapMiClient : EbiWS.AbstractWsClient
	{
