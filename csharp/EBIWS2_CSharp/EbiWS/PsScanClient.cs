 ...
 * 
 * ======================================================================
 * JDispatcher SOAP client for PROSTIE Scan
 * 
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/ps_scan_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.PsScanWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI PROSITE Scan SOAP web service.
	/// </summary>
	public class PsScanClient : EbiWS.AbstractWsClient
	{
