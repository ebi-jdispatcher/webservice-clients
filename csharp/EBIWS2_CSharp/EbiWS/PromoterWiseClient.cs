 ...
 * 
 * ======================================================================
 * JDispatcher promoterwise (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.PromoterWiseWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI promoterwise (SOAP) web service.
	/// </summary>	
	public class PromoterWiseClient : EbiWS.AbstractWsClient
	{
