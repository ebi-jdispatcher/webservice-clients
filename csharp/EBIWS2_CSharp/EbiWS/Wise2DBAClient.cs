 ...
 * 
 * ======================================================================
 * JDispatcher Wise2DBA (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.Wise2DBAWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI Wise2DBA (SOAP) web service.
	/// </summary>	
	public class Wise2DBAClient : EbiWS.AbstractWsClient
	{
