/* $Id: GeneWiseClient.cs 2006 2011-09-01 13:51:24Z hpm $
 * ======================================================================
 * 
 ...
 * 
 * ======================================================================
 * JDispatcher GeneWise  (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.GeneWiseWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI GeneWise (SOAP) web service.
	/// </summary>	
	public class GeneWiseClient : EbiWS.AbstractWsClient
	{
