 ...
 * 
 * ======================================================================
 * JDispatcher SOAP client for SeqCksum
 * 
 * See:
...
using System;
using System.IO;
using EbiWS.SeqCksumWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI SeqCksum SOAP web service.
	/// </summary>
	public class SeqCksumClient : EbiWS.AbstractWsClient
	{
