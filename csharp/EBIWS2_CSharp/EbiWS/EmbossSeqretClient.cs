 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS seqret (SOAP) client.
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_seqret_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossSeqretWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS seqret (SOAP) web service.
	/// </summary>	
	public class EmbossSeqretClient : EbiWS.AbstractWsClient
	{
