/* $Id: SapsClient.cs 2006 2011-09-01 13:51:24Z hpm $
 * ======================================================================
 * 
 ...
 * 
 * ======================================================================
 * JDispatcher Saps (SOAP) web service .NET/Mono client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.SapsWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI Saps (SOAP) web service.
	/// </summary>	
	public class SapsClient : EbiWS.AbstractWsClient
	{
