 ...
 * 
 * ======================================================================
 * JDispatcher DbClustal (SOAP) web service .NET/Mono client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.DbClustalWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI DbClustal (SOAP) web service.
	/// </summary>	
	public class DbClustalClient : EbiWS.AbstractWsClient
	{
