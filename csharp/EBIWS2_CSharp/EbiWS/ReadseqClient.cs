 ...
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/pfa/readseq_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.ReadseqWs; // "Web Reference" or wsdl.exe generated stubs.
...
namespace EbiWS
{
	...
	/// </summary>
	public class ReadseqClient : EbiWS.AbstractWsClient
	{
