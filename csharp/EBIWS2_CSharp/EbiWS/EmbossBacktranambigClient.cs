/* $Id$
 * ======================================================================
 * JDispatcher EMBOSS backtranambig (SOAP) client.
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_backtranambig_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossBacktranambigWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS backtranambig (SOAP) web service.
	/// </summary>	
	public class EmbossBacktranambigClient : EbiWS.AbstractWsClient
	{
