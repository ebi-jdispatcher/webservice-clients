/* $Id$
 * ======================================================================
 * JDispatcher SOAP client for FASTM
 * 
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/fastm_soap
...
{
	/// <summary>
	/// Client for EMBL-EBI FASTM SOAP web service.
	/// </summary>
	public class FastmClient : EbiWS.AbstractWsClient
	{
		...
		private string revision = "$Revision: 1635 $";
