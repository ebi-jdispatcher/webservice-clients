/* $Id: EmbossPepstatsClient.cs 2065 2011-12-09 11:38:13Z wli $
 * ======================================================================
 * JDispatcher EMBOSS pepstats (SOAP) client.
 *
 * See:
...
using System;
using System.IO;
using EbiWS.EmbossPepstatsWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS pepstats (SOAP) web service.
	/// </summary>	
	public class EmbossPepstatsClient : EbiWS.AbstractWsClient
	{
