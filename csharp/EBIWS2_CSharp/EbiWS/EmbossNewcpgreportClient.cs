 ...
 * 
 * ======================================================================
 * JDispatcher EMBOSS newcpgreport (SOAP) client.
 *
 * See:
 * http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_newcpgreport_soap
 * http://www.ebi.ac.uk/Tools/webservices/tutorials/csharp
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossNewcpgreportWs; // "Web Reference" or wsdl.exe generated stubs.

namespace EbiWS
{
	/// <summary>
	/// Client for EMBL-EBI EMBOSS newcpgreport (SOAP) web service.
	/// </summary>	
	public class EmbossNewcpgreportClient : EbiWS.AbstractWsClient
	{
