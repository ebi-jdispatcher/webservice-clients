 ...
 * 
 * ======================================================================
 * jDispatcher SOAP command-line client for InterProScan 5.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.IPRScan5Ws;

namespace EbiWS
{
	class IPRScan5CliClient : EbiWS.IPRScan5Client
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"InterProScan 5
==============
...
";
		...
		public static int Main(string[] args)
		{
			...
			IPRScan5CliClient wsApp = new IPRScan5CliClient();
