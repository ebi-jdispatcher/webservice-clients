 ...
 * 
 * ======================================================================
 * jDispatcher EMBOSS matcher (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossMatcherWs;

namespace EbiWS
{
	class EmbossMatcherCliClient : EbiWS.EmbossMatcherClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS matcher
==============
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossMatcherCliClient wsApp = new EmbossMatcherCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "/x":
					goto case "--gapext";
				case "--alternatives": // Number of alternative alignments.
					InParams.alternatives  = Convert.ToInt32(args[++i]);
					InParams.alternativesSpecified = true;
					break;
				case "/alternatives":
					goto case "--alternatives";
				case "-a":
					goto case "--alternatives";
				case "/a":
					goto case "--alternatives";
