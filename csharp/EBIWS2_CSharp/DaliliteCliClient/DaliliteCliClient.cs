...
using System;
using System.IO;
using EbiWS.DaliliteWs;

namespace EbiWS
{
	class DaliliteCliClient : EbiWS.DaliliteClient
	{
...
";
		...
		public static int Main(string[] args)
		{
			...
			DaliliteCliClient wsApp = new DaliliteCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				switch (args[i])
				{
					...
					case "--chainid1": //
						InParams.chainid1 = args[++i];
						break;
					case "/chainid1":
						goto case "--chainid1";
					case "--chainid2": //
						InParams.chainid2 = args[++i];
						break;
					case "/chainid2":
						goto case "--chainid2";
					...
					// Input data options.
					case "--structure1": // First structure.
						InParams.structure1 = LoadData(args[++i]);
						Action = "submit";
						break;
					case "--structure2": // Second structure.
						InParams.structure2 = LoadData(args[++i]);
						Action = "submit";
						break;
