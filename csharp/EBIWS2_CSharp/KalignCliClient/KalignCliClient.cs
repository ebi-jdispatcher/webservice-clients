/* $Id: ClustalW2CliClient.cs 1373 2010-02-02 20:03:42Z hpm $
 * ======================================================================
 * jDispatcher SOAP command-line client for Kalign
 * ====================================================================== */
using System;
using System.IO;
...
";
		...
		public static int Main(string[] args)
		{
			...
			KalignCliClient wsApp = new KalignCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "/x":
					goto case "--gapext";
				case "--termgap": // Terminal gap penalty
					InParams.termgap = Convert.ToSingle(args[++i]);
					InParams.termgapSpecified = true;
					break;
				case "/termgap":
					goto case "--termgap";
				case "-t":
				...
				case "--bonus": // Bonus score
					InParams.bonus = Convert.ToSingle(args[+i]);
					InParams.bonusSpecified = true;
					break;
				case "/bonus":
					goto case "--bonus";
				case "-b":
