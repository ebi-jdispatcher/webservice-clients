...
using System;
using System.IO;
using EbiWS.MaxsproutWs;

namespace EbiWS
{
	class MaxsproutCliClient : EbiWS.MaxsproutClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"MaxSprout
================

Generate protein backbone and side chain co-ordinates from a C(alpha) trace.
...
";
		...
		public static int Main(string[] args)
		{
			...
			MaxsproutCliClient wsApp = new MaxsproutCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "--coordinates": // Input coordinates.
					InParams.coordinates = LoadData(args[++i]);
					Action = "submit";
					break;
				case "/coordinates":
					goto case "--coordinates";
				default:
