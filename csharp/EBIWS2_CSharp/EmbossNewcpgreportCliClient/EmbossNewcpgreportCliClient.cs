 ...
 * 
 * ======================================================================
 * jDispatcher EMBOSS newcpgreport (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossNewcpgreportWs;

namespace EbiWS
{
	class EmbossNewcpgreportCliClient : EbiWS.EmbossNewcpgreportClient
	{
		/// <summary>Tool specific usage</summary>
		private string usageMsg = @"EMBOSS newcpgreport
===================
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossNewcpgreportCliClient wsApp = new EmbossNewcpgreportCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "--minlen": // Minimum length
					InParams.minlen = Convert.ToInt32(args[++i]);
					InParams.minlenSpecified = true;
					break;
				case "/minlen":
					goto case "--minlen";
				case "--minoe": // Minimum obs/exp ratio
					InParams.minoe = Convert.ToSingle(args[++i]);
					InParams.minoeSpecified = true;
					break;
				case "/minoe":
					goto case "--minoe";
				case "--minpc": // Minimum percentage
					InParams.minpc = Convert.ToSingle(args[++i]);
					InParams.minpcSpecified = true;
					break;
				case "/minpc":
					goto case "--minpc";
