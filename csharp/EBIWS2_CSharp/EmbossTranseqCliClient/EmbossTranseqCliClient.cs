 ...
 * 
 * ======================================================================
 * jDispatcher EMBOSS transeq (SOAP) command-line client.
 * ====================================================================== */
using System;
using System.IO;
using EbiWS.EmbossTranseqWs;

namespace EbiWS
{
	class EmbossTranseqCliClient : EbiWS.EmbossTranseqClient
	{
...
";
		...
		public static int Main(string[] args)
		{
			...
			EmbossTranseqCliClient wsApp = new EmbossTranseqCliClient();
		...
		private void ParseCommand(string[] args)
		{
			...
			for (int i = 0; i < args.Length; i++)
			{
				...
				case "--frame": // Frames to be translated
					InParams.frame = args[++i];
					break;
				case "/frame":
					goto case "--frame";
				...
				case "--regions": // Regions to be translated
					InParams.regions = args[++i];
					break;
				case "/regions":
					goto case "--regions";
				case "--trim": // Enable Trim
					InParams.trim = true;
					InParams.trimSpecified = true;
					break;
				case "/trim":
					goto case "--trim";
				case "--notrim": // Disable Trim
					InParams.trim = false;
					InParams.trimSpecified = true;
					break;
				case "/notrim":
