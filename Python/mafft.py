...
#
# Mafft (REST) web service Python client.
#
###############################################################################
...
description = u'''Multiple sequence alignment with Mafft.'''
epilog = u'''For further information about the Mafft web service, see
https://www.ebi.ac.uk/tools/webservices/services/msa/mafft_rest.'''
version = u'798c88f'
...
parser.add_option('--matrix', help=('Protein comparison matrix to be used when adding sequences to the'
                  'alignment.'))
