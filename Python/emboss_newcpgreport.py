...
#
# EMBOSS newcpgreport (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with newcpgreport.'''
epilog = u'''For further information about the EMBOSS newcpgreport web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_newcpgreport_rest.'''
version = u'798c88f'
