...
#
# EMBOSS pepinfo (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with pepinfo.'''
epilog = u'''For further information about the EMBOSS pepinfo web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_pepinfo_rest.'''
version = u'798c88f'
