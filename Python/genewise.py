...
#
# Genewise (REST) web service Python client.
#
###############################################################################
...
description = u'''Pairwise sequence alignment with Genewise.'''
epilog = u'''For further information about the Genewise web service, see
https://www.ebi.ac.uk/tools/webservices/services/psa/genewise_rest.'''
version = u'798c88f'
