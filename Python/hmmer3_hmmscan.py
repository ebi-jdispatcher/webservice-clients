...
#
# HMMER 3 hmmscan (REST) web service Python client.
#
###############################################################################
...
description = u'''Protein function analysis with HMMER 3 hmmscan.'''
epilog = u'''For further information about the HMMER 3 hmmscan web service, see
https://www.ebi.ac.uk/tools/webservices/services/pfa/hmmer3_hmmscan_rest.'''
version = u'798c88f'
