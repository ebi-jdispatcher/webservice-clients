...
#
# EMBOSS cpgplot (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with cpgplot.'''
epilog = u'''For further information about the EMBOSS cpgplot web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_cpgplot_rest.'''
version = u'798c88f'
