...
#
# InterProScan 5 (REST) web service Python client.
#
###############################################################################
...
description = u'''Protein function analysis with InterProScan 5.'''
epilog = u'''For further information about the InterProScan 5 web service, see
https://www.ebi.ac.uk/tools/webservices/services/pfa/iprscan5_rest.'''
version = u'798c88f'
