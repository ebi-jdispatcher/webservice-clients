...
#
# PfamScan (REST) web service Python client.
#
###############################################################################
...
description = u'''Protein function analysis with PfamScan.'''
epilog = u'''For further information about the PfamScan web service, see
https://www.ebi.ac.uk/tools/webservices/services/pfa/pfamscan_rest.'''
version = u'798c88f'
