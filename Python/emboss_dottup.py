...
#
# EMBOSS dottup (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence statistics and plots with dottup.'''
epilog = u'''For further information about the EMBOSS dottup web service, see
https://www.ebi.ac.uk/tools/webservices/services/seqstats/emboss_dottup_rest.'''
version = u'798c88f'
