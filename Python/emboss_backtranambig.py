...
#
# EMBOSS backtranambig (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence translations with backtranambig.'''
epilog = u'''For further information about the EMBOSS backtranambig web service, see
https://www.ebi.ac.uk/tools/webservices/services/st/emboss_backtranambig_rest.'''
version = u'798c88f'
