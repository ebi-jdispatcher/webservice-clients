...
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, DataType:="int")>  _
        Public alignments As System.Nullable
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnore()>  _
        Public alignmentsSpecified As Boolean
        
        '''<remarks>
'''Scores [Maximum number of match score summaries reported in the result output.]
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, DataType:="int")>  _
        Public scores As System.Nullable
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnore()>  _
        Public scoresSpecified As Boolean
...
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, DataType:="int")>  _
        Public dropoff As System.Nullable
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnore()>  _
        Public dropoffSpecified As Boolean
        
        '''<remarks>
'''Match/mismatch scores [(Nucleotide searches) The match score is the bonus to the alignment score when matching the same base. The mismatch is the penalty when failing to match.]
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true)>  _
        Public match_scores As String
...
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, DataType:="int")>  _
        Public gapopen As System.Nullable
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnore()>  _
        Public gapopenSpecified As Boolean
...
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, DataType:="int")>  _
        Public gapext As System.Nullable
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnore()>  _
        Public gapextSpecified As Boolean
...
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true)>  _
        Public seqrange As String
        
        '''<remarks>
'''Gapalign [This is a true/false setting that tells the program the perform optimised alignments within regions involving gaps. If set to true, the program will perform an alignment using gaps. Otherwise, if it is set to false, it will report only individual HSP where two sequence match each other, and thus will not produce alignments with gaps.]
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, DataType:="boolean")>  _
        Public gapalign As System.Nullable
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnore()>  _
        Public gapalignSpecified As Boolean
        
        '''<remarks>
'''Align views [Formating for the alignments]
'''</remarks>
        <System.Xml.Serialization.XmlElementAttribute(IsNullable:=true, DataType:="int")>  _
        Public align As System.Nullable
        
        '''<remarks/>
        <System.Xml.Serialization.XmlIgnore()>  _
        Public alignSpecified As Boolean
