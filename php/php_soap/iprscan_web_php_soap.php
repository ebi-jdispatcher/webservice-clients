...
# 
# ======================================================================
# PHP InterProScan (SOAP) web client
#
# Tested with:
#   PHP 5.1.6 (CentOS 5)
...
#
# See:
# http://www.ebi.ac.uk/Tools/webservices/services/sss/iprscan_soap
...
// Extend client class
class IPRScanWebClient extends IPRScanClient {
...
EOF
  ...
  function printResult($jobId, $resultType) {
    ...
    elseif(strpos($selResultTypeObj->mediaType, 'image') === 0 &&
      ...
      $resultUrl = 'http://www.ebi.ac.uk/Tools/services/rest/iprscan/result/';
...
if(floatval(phpversion()) < 5.0) {
  ...
  try {
    ...
    // Submit a job
    elseif(array_key_exists('sequence', $inputParams)) {
