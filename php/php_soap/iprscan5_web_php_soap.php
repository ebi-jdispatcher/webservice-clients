...
# 
# ======================================================================
# PHP InterProScan 5 (SOAP) web client
#
# Tested with:
#   PHP 5.1.6 (CentOS 5)
...
// Extend client class
class IPRScan5WebClient extends IPRScan5Client {
...
EOF
  ...
  function printResult($jobId, $resultType) {
    ...
    elseif(strpos($selResultTypeObj->mediaType, 'image') === 0 &&
      ...
      $resultUrl = 'http://www.ebi.ac.uk/Tools/services/rest/iprscan5/result/';
...
<h1 align="center">InterProScan 5 (SOAP)</h1>
<hr />
...
<head>
<title>InterProScan 5 (SOAP)</title>
</head>
<?php
// Meta refresh
print $metaRefresh;
