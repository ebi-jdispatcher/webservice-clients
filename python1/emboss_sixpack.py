...
#
# EMBOSS sixpack (REST) web service Python client.
#
###############################################################################
...
description = u'''Sequence translations with sixpack.'''
epilog = u'''For further information about the EMBOSS sixpack web service, see
https://www.ebi.ac.uk/tools/webservices/services/st/emboss_sixpack_rest.'''
version = u'798c88f'
