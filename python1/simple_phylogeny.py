...
#
# Simple Phylogeny (REST) web service Python client.
#
###############################################################################
...
description = u'''Generating Phylogenetic Trees with Simple Phylogeny.'''
epilog = u'''For further information about the Simple Phylogeny web service, see
https://www.ebi.ac.uk/tools/webservices/services/phylogeny/simple_phylogeny_rest.'''
version = u'798c88f'
