...
#
# EMBOSS matcher (REST) web service Python client.
#
###############################################################################
...
description = u'''Pairwise sequence alignment with Matcher.'''
epilog = u'''For further information about the EMBOSS matcher web service, see
https://www.ebi.ac.uk/tools/webservices/services/psa/emboss_matcher_rest.'''
version = u'798c88f'
