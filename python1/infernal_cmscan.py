...
#
# Infernal CM Scan (REST) web service Python client.
#
###############################################################################
...
description = u'''RNA analysis with Infernal CM Scan.'''
epilog = u'''For further information about the Infernal CM Scan web service, see
https://www.ebi.ac.uk/tools/webservices/services/rna/infernal_cmscan_rest.'''
version = u'798c88f'
