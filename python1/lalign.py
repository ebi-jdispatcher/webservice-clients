...
#
# LALIGN (REST) web service Python client.
#
###############################################################################
...
description = u'''Pairwise sequence alignment with Lalign.'''
epilog = u'''For further information about the LALIGN web service, see
https://www.ebi.ac.uk/tools/webservices/services/psa/lalign_rest.'''
version = u'798c88f'
