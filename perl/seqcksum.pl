...
[Optional]
  --stype               : str  : Indicates if the sequences are protein or nucleotide (DNA/RNA).
  --cksmethod           : str  : A number of different checksum methods for sequences are launched.
  --length              : bool : Turn on/off the display of asequence length.
