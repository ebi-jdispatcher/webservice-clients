...
emboss_newcpgreport.pl

=head1 DESCRIPTION

EMBOSS newcpgreport (REST) web service Perl client using L<LWP>.
...
my $baseUrl = 'https://www.ebi.ac.uk/Tools/services/rest/emboss_newcpgreport';
...
sub usage {
    print STDERR <<EOF
EMBL-EBI EMBOSS newcpgreport Python Client:
