...
emboss_backtranambig.pl

=head1 DESCRIPTION

EMBOSS backtranambig (REST) web service Perl client using L<LWP>.
...
my $baseUrl = 'https://www.ebi.ac.uk/Tools/services/rest/emboss_backtranambig';
...
[Optional]
  --codontable          : str  : Which genetic code table to use. These are kept synchronised with
                                 those maintained at the NCBI's Taxonomy Browser.
  --sequence            : str  : One or more sequences to be translated can be entered directly into
