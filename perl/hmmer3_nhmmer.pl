...
HMMER3 nhmmer (REST) web service Perl client using L<LWP>.
...
my $baseUrl = 'https://www.ebi.ac.uk/Tools/services/rest/hmmer3_nhmmer';
my $version = '2024-07-23 15:05';
...
sub usage {
    print STDERR <<EOF
EMBL-EBI HMMER3 nhmmer Perl Client:
