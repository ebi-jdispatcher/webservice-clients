...
[Optional]
  ...
  --gapopen             : flo  : Pairwise alignment score for the first residue in a gap.
  --gapext              : flo  : Pairwise alignment score for each additional residue in a gap.
  --endweight           : bool : Apply end gap penalty
  --endopen             : flo  : Score taken away when an end gap is created.
  --endextend           : flo  : Penalty is added to the end gap penalty for each base or residue in
  ...
  --asequence           : str  : A free text (raw) list of sequences is simply a block of characters
  ...
  --bsequence           : str  : A free text (raw) list of sequences is simply a block of characters
                                 representing several DNA/RNA or Protein sequences. A sequence can be
                                 in GCG, FASTA, EMBL (Nucleotide only), GenBank, PIR, NBRF, PHYLIP or
                                 UniProtKB/Swiss-Prot (Protein only) format. Partially formatted
                                 sequences are not accepted. Adding a return to the end of the sequence
