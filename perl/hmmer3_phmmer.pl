...
[Optional]
  --incE                : str  : Significance E-values[Sequence]
  --incdomE             : str  : Significance E-values[Hit]
  --E                   : str  : Report E-values[Sequence]
  ...
  --popen               : str  : Gap Penalties[open]
  --pextend             : str  : Gap Penalties[extend]
  --mx                  : str  : Gap Penalties[Substitution scoring matrix]
  --nobias              : bool : Filters
