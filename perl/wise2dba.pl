...
[Optional]
  --para                : bool : Show parameters in output alignmment, as in genewise.
  --pretty              : bool : Show pretty ASCII alignment viewing, as in genewise.
  --asequence           : str  : The first DNA sequence to be aligned can be entered directly into the
                                 ...
                                 entry.
  --bsequence           : str  : The second DNA sequence to be aligned can be entered directly into the
                                 form. The sequence must be in a recognised format eg. GCG, FASTA,
                                 EMBL, GenBank. Partially formatted sequences are not accepted. Adding
                                 a return to the end of the sequence may help certain applications
                                 understand the input. Note that directly using data from word
