...
GGSEARCH2SEQ (REST) web service Perl client using L<LWP>.
...
my $baseUrl = 'https://wwwdev.ebi.ac.uk/Tools/services/rest/ggsearch2seq';
...
sub usage {
    print STDERR <<EOF
EMBL-EBI GGSEARCH2SEQ Perl Client:
