...
T-coffe (REST) web service Perl client using L<LWP>.
...
my $baseUrl = 'https://www.ebi.ac.uk/Tools/services/rest/tcoffee';
...
[Optional]
  ...
  --matrix              : str  : Matrix series to use when generating the multiple sequence alignment.
