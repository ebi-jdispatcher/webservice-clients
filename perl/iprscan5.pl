...
[Optional]
  --goterms             : bool : Switch on look-up of corresponding Gene Ontology annotations
  --pathways            : bool : Switch on look-up of corresponding pathway annotations
  --appl                : str  : A number of different protein sequence applications are launched.
                                 These applications search against specific databases and have
                                 preconfigured cut off thresholds.
  --sequence            : str  : Your protein sequence can be entered directly into this form in GCG,
