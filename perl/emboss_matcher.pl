...
my $baseUrl = 'https://www.ebi.ac.uk/Tools/services/rest/emboss_matcher';
...
GetOptions(
    ...
    'alternatives=i'  => \$tool_params{'alternatives'},   # Show additional alignments
...
[Optional]
  ...
  --alternatives        : int  : Show additional alignments
