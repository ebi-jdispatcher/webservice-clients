...
my $baseUrl = 'https://www.ebi.ac.uk/Tools/services/rest/emboss_sixpack';
...
[Optional]
  ...
  --firstorf            : bool : Count the beginning of a sequence as a possible ORF, even if it's
                                 inferior to the minimal ORF size.
  --lastorf             : bool : Count the end of a sequence as a possible ORF, even if it's not
                                 finishing with a STOP, or inferior to the minimal ORF size.
  --reverse             : bool : Choose this option if you wish to reverse and compliment your
                                 sequence.
  --orfminsize          : str  : Minimum size of Open Reading Frames (ORFs) to display in the
                                 translations.
  --sequence            : str  : A DNA sequence can be entered or pasted into this box. Ideally use a
