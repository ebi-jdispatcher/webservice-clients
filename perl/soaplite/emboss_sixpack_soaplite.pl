...
emboss_sixpack_soaplite.pl

=head1 DESCRIPTION

EMBOSS Sixpack (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_sixpack_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/emboss_sixpack?wsdl';
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_sixpack_soap
