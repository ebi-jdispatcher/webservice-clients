...
emboss_backtranambig_soaplite.pl

=head1 DESCRIPTION

EMBOSS Backtranambig (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_backtranambig_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/emboss_backtranambig?wsdl';
...
Back-translate a protein sequence into nucleotide sequence using ambiguous 
codons.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_backtranambig_soap
