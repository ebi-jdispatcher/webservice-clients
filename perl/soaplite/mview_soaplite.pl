...
MView (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/msa/mview_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/mview?wsdl';
