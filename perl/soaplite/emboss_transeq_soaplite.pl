...
emboss_transeq_soaplite.pl

=head1 DESCRIPTION

EMBOSS transeq (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_transeq_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/emboss_transeq?wsdl';
...
GetOptions(
	...
	'frame=s'       => \$tool_params{'frame'},      # The frames to be translated.
	'codontable=s'  => \$tool_params{'codontable'}, # Codon Table
	'regions=s'     => \$tool_params{'regions'},    # Regions to be translated
	'trim'          => \$params{'trim'},            # Enable Trim
	'notrim'        => \$params{'notrim'},          # Disable Trim
	'reverse'       => \$params{'reverse'},         # Enable Reverse
	'noreverse'     => \$params{'noreverse'},       # Disable Reverse
...
Translate nucleic acid sequences to their corresponding peptide sequences. It 
can translate to the three forward and three reverse frames, and output 
multiple frame translations at once.
...
[Optional]
     ...
     --codontable    : str  : codon table
     --regions       : str  : regions to be translated
     --trim          :      : enable to trim
     --notrim        :      : disable to trim
     --reverse       :      : enable to reverse
     --noreverse     :      : disable to reverse
