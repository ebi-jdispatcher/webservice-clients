...
emboss_pepwindow_soaplite.pl

=head1 DESCRIPTION

EMBOSS Pepwindow (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_pepwindow_soap>
...
$Id: emboss_pepwindow_soaplite.pl 2043 2011-12-01 10:37:18Z wli $
...
my $WSDL = 'http://wwwdev.ebi.ac.uk/Tools/services/soap/emboss_pepwindow?wsdl';
...
GetOptions(
	...
	'windowsize=i'  => \$tool_params{'windowsize'},# Window size
	'normalize'     => \$params{'normalize'},      # Normalize data values
	'nonormalize'   => \$params{'nonormalize'},    # Not normalize data values
...
sub load_params {
	...
	# Enable/disable normalise-data-values
	if($params{'normalize'}) {
		$tool_params{'normalize'} = 'true';
	}
	elsif($params{'nonormalize'}) {
		$tool_params{'normalize'} = 'false';
	}
...
[Optional]
     ...
     --nonormalize    :      : not normalize data
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_pepwindow_soap
