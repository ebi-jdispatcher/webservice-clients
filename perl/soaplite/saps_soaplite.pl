...
SAPS (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/seqstats/saps_soap>
...
$Id: saps_soaplite.pl 2043 2011-12-01 10:37:18Z wli $
...
[Optional]
     ...
     --outputtype       :      : output type, see --paramDetail outputtype
...
[General]
  ...
  -h, --help            :      : prints this help text
      ...
      --useSeqId        :      : use sequence identifiers for output filenames. 
                                 Only available in multifasta or list file 
                                 modes.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/seqstats/saps_soap
