...
pfamscan_soaplite.pl

=head1 DESCRIPTION

PfamScan (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/pfa/pfamscan_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/pfamscan?wsdl';
