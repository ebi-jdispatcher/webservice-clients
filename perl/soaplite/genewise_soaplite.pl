...
genewise_soaplite.pl

=head1 DESCRIPTION

GeneWise (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/genewise_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/genewise?wsdl';
