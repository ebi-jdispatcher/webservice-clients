...
emboss_isochore_soaplite.pl

=head1 DESCRIPTION

EMBOSS isochore (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_isochore_soap>
...
$Id: emboss_isochore_soaplite.pl 2043 2011-12-01 10:37:18Z wli $
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/emboss_isochore?wsdl';
...
GetOptions(
	...
	'shift=i'     => \$tool_params{'shift'},  # Shift increment.
	'window=i'    => \$tool_params{'window'}, # Windows size.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_isochore_soap
