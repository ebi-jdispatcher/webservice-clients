...
infernal_cmscan_soaplite.pl

=head1 DESCRIPTION

Infernal cmscan(SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/rna/infernal_cmscan_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/infernal_cmscan?wsdl';
...
GetOptions(
	...
	'thresholdmodel=s' => \$tool_params{'thresholdmodel'},  # Threshold Model
...
For more information on Infernal cmscan refer to 
http://www.ebi.ac.uk/Tools/rna/infernal_cmscan
...
[Optional]
      ...
      --thresholdmodel : str  : Threshold model, see --paramDetails thresholdmodel.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/rna/infernal_cmscan_soap
