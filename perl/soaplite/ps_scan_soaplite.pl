...
PROSITE Scan (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/pfa/ps_scan_soap>
...
[Optional]
      --format             : str  : output format, see --paramDetail format
      --database           : str  : database to scan, see see 
...
[General]
  ...
  -h, --help               :      : prints this help text
      ...
      --useSeqId           :      : use sequence identifiers for output 
                                    filenames. Only available in multifasta 
                                    or list file modes.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/pfa/ps_scan_soap
