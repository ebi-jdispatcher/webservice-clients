...
hmmer_hmmscan_soaplite.pl

=head1 DESCRIPTION

HMMER hmmscan (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/pfa/hmmer_hmmscan_soap>
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/pfa/hmmer_hmmscan_soap
