...
promoterwise_soaplite.pl

=head1 DESCRIPTION

PromoterWise (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/promoterwise_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/promoterwise?wsdl';
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/psa/promoterwise_soap
