...
emboss_newcpgreport_soaplite.pl

=head1 DESCRIPTION

EMBOSS newcpgreport (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_newcpgreport_soap>
...
$Id: emboss_newcpgreport_soaplite.pl 2043 2011-12-01 10:37:18Z wli $
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/emboss_newcpgreport?wsdl';
...
GetOptions(
	...
	'minlen=i'    => \$tool_params{'minlen'}, # Minimum length of a CpG island.
	'minoe=f'     => \$tool_params{'minoe'},  # Minumun observed/expected ratio.
	'minpc=f'     => \$tool_params{'minpc'},  # Minimum CpG percentage.
	'window=i'    => \$tool_params{'window'}, # Windows size for CpG calculation.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_newcpgreport_soap
