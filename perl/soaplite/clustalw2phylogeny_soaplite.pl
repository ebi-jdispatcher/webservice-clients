...
clustalw2phylogeny_soaplite.pl

=head1 DESCRIPTION

ClustalW2 Phylogeny (SOAP) web service Perl client using L<SOAP::Lite>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/phylogeny/clustalw2phylogeny_soap>
...
my $WSDL = 'http://www.ebi.ac.uk/Tools/services/soap/clustalw2_phylogeny?wsdl';
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/phylogeny/clustalw2phylogeny_soap
