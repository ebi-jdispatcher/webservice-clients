...
iprscan_xmlcompile.pl

=head1 DESCRIPTION

InterProScan (SOAP) web service Perl client using L<XML::Compile::SOAP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/pfa/iprscan_soap>
