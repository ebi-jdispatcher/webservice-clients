...
ncbiblast_xmlcompile.pl

=head1 DESCRIPTION

NCBI BLAST SOAP web service Perl client using L<XML::Compile::SOAP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/sss/ncbi_blast_soap>
