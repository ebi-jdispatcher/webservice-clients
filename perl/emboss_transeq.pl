...
[Optional]
  --frame               : str  : The frames to be translated. The order of the frames follows the
  ...
  --regions             : str  : Which regions of the user's DNA molecule are to be translated.
  --trim                : bool : Remove '*' and 'X' (stop and ambiguity) symbols from the end of the
                                 translation.
  --reverse             : bool : Choose this option if you wish to reverse and complement your input
                                 sequence before frame translation.
  --sequence            : str  : Any input formats accepted by EMBOSS can be used, the full list of
