...
my $baseUrl = 'https://www.ebi.ac.uk/Tools/services/rest/saps';
...
[Optional]
  ...
  --species             : str  : Uses the specified species table for quantile comparisons
  --positiveresidues    : str  : By default, SAPS treats only lysine (K) and arginine (R) as positively
