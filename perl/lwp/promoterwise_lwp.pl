...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/promoterwise_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/promoterwise';
...
GetOptions(
    ...
    'hitoutput|o=s'  => \$tool_params{'hitoutput'},  # Hit list output format
...
PromoterWise compares two DNA sequences allowing for inversions and translocations,
 ideal for promoters. 
