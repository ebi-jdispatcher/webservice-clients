...
[Required]
	...
	-D, --database     : str  : This field indicates which profile HMM database the query
	                            should be searched against. Accepted values are:
															gene3d, pfam, tigrfam, superfamily, pirsf
