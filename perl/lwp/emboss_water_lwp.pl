...
EMBOSS water (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_water_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_water';
