...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_dotpath_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_dotpath';
...
GetOptions(
    ...
    'wordsize|w=i'     => \$tool_params{'wordsize'},     # Window size
    'overlaps|o=s'     => \$tool_params{'overlaps'},     # Overlaps
    'boxit|b=s'        => \$tool_params{'boxit'},        # Boxit
...
Local pairwise sequence alignment using EMBOSS dotpath.
...
[Optional]
  ...
  -w, --wordsize      : int  : word size (2 or more)
  -o, --overlaps      : bool  : Displays the overlapping matches (in red)
                                as well as the minimal set of non-overlapping
                                matches (default is false)
                                Values: 'true' or 'false'.
  -b, --boxit         : bool  : Draw a box around dotplot (default is true)
                                Values: 'true' or 'false'.
  # -g, --graph         : str  : graph type (svg, png, etc.)
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_dotpath_rest
