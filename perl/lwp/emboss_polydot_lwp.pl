...
emboss_polydot_lwp.pl

=head1 DESCRIPTION

EMBOSS polydot (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_polydot_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_polydot';
...
Local pairwise sequence alignment using EMBOSS polydot.
...
[Optional]
  ...
  -g, --gap           : int  : This specifies the size of the gap that
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_polydot_rest
