...
EMBOSS isochore (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_isochore_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_isochore';
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/seqstats/emboss_isochore_rest
