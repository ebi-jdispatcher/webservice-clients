...
emboss_dottup_lwp.pl

=head1 DESCRIPTION

EMBOSS dottup (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_dottup_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_dottup';
...
Local pairwise sequence alignment using EMBOSS dottup.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_dottup_rest
