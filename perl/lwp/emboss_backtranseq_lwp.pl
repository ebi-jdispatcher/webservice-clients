...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_backtranseq_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_backtranseq';
...
Back-translate protein sequence(s) to nucleotide sequence(s).
