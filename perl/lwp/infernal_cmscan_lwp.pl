...
Infernal cmscan (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/rna/infernal_cmscan_rest>
...
Infernal cmscan, a tool for mapping and analysis of miRNA sequences.
