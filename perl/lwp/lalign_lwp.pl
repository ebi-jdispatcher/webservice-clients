...
Lalign (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/lalign_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/lalign';
...
GetOptions(
    ...
    'match_scores|r=s' => \$tool_params{'match_scores'}, # DNA match/missmatch scores
    'gapopen|f=i'    => \$tool_params{'gapopen'},   # Gap creation penalty
    'gapext|g=i'     => \$tool_params{'gapext'},    # Gap extension penalty
    'expthr|E=f'     => \$tool_params{'expthr'}, # E-value threshold
    ...
    'graphics'       => \$tool_params{'graphics'},   # Enable graphic output
