...
emboss_dotmatcher_lwp.pl

=head1 DESCRIPTION

EMBOSS dotmatcher (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_dotmatcher_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_dotmatcher';
...
GetOptions(
    ...
    'windowsize|w=i'   => \$tool_params{'windowsize'},   # Window size
    'threshold|t=i'    => \$tool_params{'threshold'},    # Threshold
...
Local pairwise sequence alignment using EMBOSS dotmatcher.
...
[Optional]
  ...
  -w, --windowsize    : int  : window size over which to test threshold (3 or more)
  -t, --threshold     : int  : threshold (0 or more)
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/psa/emboss_dotmatcher_rest
