...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_transeq_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/emboss_transeq';
...
It can translate to the three forward and three reverse frames, and output
...
[Optional]
     ...
     --trim          :      : trim '*' and 'X' from ORF sequences
     --notrim        :      : do not trim '*' and 'X' from ORF sequences
     --reverse       :      : reverse complement input sequence
     --noreverse     :      : use original input sequence
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/st/emboss_transeq_rest
