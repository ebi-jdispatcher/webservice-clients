...
SAPS (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/seqstats/saps_rest>
...
$Id: saps_lwp.pl 2079 2012-03-08 10:11:17Z hpm $
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/saps';
...
GetOptions(
	...
	'species=s'          => \$tool_params{'species'},          # Species
	'positiveresidues=s' => \$tool_params{'positiveresidues'}, # Positive residues
...
SAPS evaluates by statistical criteria a wide variety of protein sequence 
properties.
...
[Optional]
      ...
      --positiveresidues : str  : positive residues, see --paramDetail 
                                  positiveresidues
...
[General]
  ...
  -h, --help             :      : prints this help text
      ...
      --jobid            : str  : jobid that was returned when an asynchronous 
                                  job was submitted.
      --outfile          : str  : file name for results (default is jobid;
                                  "-" for STDOUT)
      --useSeqId         :      : use sequence identifiers for output 
                                  filenames. Only available in multifasta or 
                                  list file modes.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/seqstats/saps_rest
