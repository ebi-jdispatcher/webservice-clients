...
[Required]
	...
	-D, --database     : str  : The sequence database field changes which target sequence
	                            database is searched. Accepted values are: ensemblgenomes,uniprotkb,uniprotrefprot,rp15,rp35,rp55,
															rp75,ensembl,merops,qfo,swissprot,pdb,meropsscan
