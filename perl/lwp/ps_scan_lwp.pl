...
PROSITE Scan (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/pfa/ps_scan_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/ps_scan';
...
Compare a protein sequence against the signatures in PROSITE.
