...
DbClustal (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/msa/dbclustal_rest>
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/msa/dbclustal_rest
