...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/psa/wise2dba_rest>
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/wise2dba';
...
GetOptions(
    ...
    'para'           => \$params{'para'},  # Parameters in output
    'nopara'         => \$params{'nopara'},  # No parameters in output
    'pretty'         => \$params{'pretty'}, # Pretty alignment format.
    'nopretty'       => \$params{'nopretty'}, # Not pretty alignment format.
    'asequence=s'    => \$params{'asequence'},       # First input DNA sequence
