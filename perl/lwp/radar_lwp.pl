...
Radar (REST) web service Perl client using L<LWP>.
...
=item *
L<http://www.ebi.ac.uk/Tools/webservices/services/pfa/radar_rest>
...
$Id: radar_lwp.pl 2079 2012-03-08 10:11:17Z hpm $
...
my $baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/radar';
...
sub rest_get_parameters {
	...
	my @param_list;
	push( @param_list, $param_list_xml->{'id'} );
...
Identify short composition biased as well as gapped approximate repeats
and complex repeat architectures.
...
Further information:
  ...
  http://www.ebi.ac.uk/Tools/webservices/services/seqstats/radar_rest
