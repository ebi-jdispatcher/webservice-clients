...
[1] java -jar dist/IPRScan5Client.jar

    // tool description

[2] java -jar dist/IPRScan5Client.jar --email user@ebi.ac.uk --sequence test-data/testpro.txt

    // <yourjobid>

[3] java -jar dist/IPRScan5Client.jar --status --jobid <yourjobid>
